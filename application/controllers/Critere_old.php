				...
				case 'ajax':
						...
						foreach ($toGetListe as $oGetListe){
							...
							if($oGetListe->fichePoste_id >0){
								$zAction  .= '<span id="manatsofoka_'.$oGetListe->id.'"><a href="#" class="dialog-view-fdp" title="Voir fiche de poste" alt="Voir fiche de poste" iAgentId="'.$oGetListe->user_id.'"><i style="font-size:22px;" class="ace-icon fa fa-search bigger-110"></i></a>&nbsp;&nbsp;&nbsp;</span>' ; 
							} else {
							...
							$zAction .= '<a href="#" class="dialog-view-note" iUserId='.$oGetListe->user_id.' title="Voir les notes" alt="Voir les notes"><i style="font-size:22px;" class="fa fa-file-text"></i></a>' ;
							$zAction = $zAction . '&nbsp;&nbsp;'. '<a href="'.base_url().'gcap/printBC/'.$oGetListe->id.'" target="_blank" title="Imprimer BC" alt="Imprimer BC"><i style="font-size:22px;" class="fa fa-print"></i></a>' ; 
							$oDataTemp[]	= $zAction;
