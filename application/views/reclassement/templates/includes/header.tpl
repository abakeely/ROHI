...
<head>
	...
	{if $zControllerName == 'pointage'}
	<title>ROHI - Pointage Electronique</title>
	{elseif $zControllerName == 'critere' || $zControllerName == 'evaluation'}
	<title>ROHI - Evaluation</title>
	{else}
	{foreach from=$oModuleActif item=oModuleActifTitle }
    <title>{if $oModuleActifTitle.module_id == 7}ROHI - titre de paiement{/if}</title>
	{/foreach}
	{/if}
	...
	<script type="text/javascript" src="{$zBasePath}assets/sau/js/jquery-1.11.3.min.js"></script>
	<script type="text/javascript" src="{$zBasePath}assets/sau/js/jquery-ui.min.js"></script>
