			...
			<div class="menu-list">
				<ul id="menu-content" class="menu-content collapse in">
					...
					<ul class="sub-menu collapse {if $iModuleActif|in_array:$toSfao}in{/if}" id="safao1">
						...
						<li {if $iModuleActif == 225} class="active" {/if}><a href="{$zBasePath}formation/insc/sfao/inscription-ligne">Formations dispensees</a></li>
					...
					<ul class="sub-menu collapse {if $iModuleActif|in_array:$toSad}in{/if}" id="sad1">
						...
						<li {if $iModuleActif == 191} class="active" {/if}><a href="{$zBasePath}documentation/couverture_nouveau/sad/collection-numerique-couverture">Nouveautes</a></li>
		...
		<li cibleli="sipamRH" class="{if $iModuleActif|in_array:$toManagement}active{/if}">
		  <a href="#"><i class="la la-gift fa-lg"></i><span class="sipam sipamRH">Management des RH</span></a>
			...
			<div class="SSmenu">
				...
				{if $oUser.im=='332026' || $oUser.im=='355577'|| $oUser.im=='111111'|| $oUser.im=='222222'|| $oUser.im=='355857'}
				<div class="hasChild"><a href="#"><i class="la la-file-text-o"></i><span>Traitement des actes</span></a>
					<div>
						...
						<div><a href="{$zBasePath}traitementActe/attributionVisaFinance"><span>Attribution des visas finance</span></a></div>
						<div><a href="{$zBasePath}traitementActe/attributionVisaCf"><span>Attribution des visas cf</span></a></div>
						<div><a href="{$zBasePath}traitementActe/mandatement"><i class="la la-file-text-o"></i><span>Mandatement</span></a></div>
