...
<div class="class_nav"><a href="#"><i class="la la-bars fa-2x toggle-btn"></i></a></div>
<div class="stickymenu">
<h2>MES FAVORIS</h2>
<ul>
{if $oUser.im=='332026'}
	<li><a href="{$zBasePath}accueil/cvAll/" title="cv des agents"><i class="ace-icon la la-users"></i>CV des agents</a></li>
	...
	{/if}
	<li><a style="padding-top:4px;" href="{$zBasePath}formation/offre/sfao/divers-offres" title="Formation"><img src="{$zBasePath}assets/img/formation-icon.png" alt="" width="52px" height="28px" align="center"/>Formation</a></li>
...
{else}
	...
	{if $iSessionCompte == COMPTE_AUTORITE || $iSessionCompte == COMPTE_EVALUATEUR|| $iSessionCompte == COMPTE_RESPONSABLE_PERSONNEL}
		<li><a href="{$zBasePath}critere/liste/agent-evaluation/fiche-de-poste-cv-notes" title="Fiche de poste / Cv / Note de mes agents"><i class="ace-icon la la-vcard"></i>Infos des agents</a></li>
	{/if}
	<li><a style="padding-top:4px;" href="{$zBasePath}formation/menu/sfao/menu-principal" title="Formation"><img src="{$zBasePath}assets/img/formation-icon.png" alt="" width="52px" height="28px" align="center"/>Formation</a></li> 
