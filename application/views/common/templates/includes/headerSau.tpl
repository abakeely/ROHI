<!-- Header -->
<div class="header" style="background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.6)), url({$zBasePath}assets/common/img/{$oRowUserTheme.0.fondPage_photo}.jpg);background-position:left;background-attachment: fixed;">

	<!-- Logo -->
	<div class="header-left">
		<a href="index.html" class="logo">
			<img src="{$zBasePath}assets/light/assets/img/logo.png" width="50" height="50" alt="">
		</a>
	</div>
	<!-- /Logo -->
	...
	<div class="page-title-box">
		<h3>Ress0urces Humaines Informatisées</h3>
	</div>
	<!-- /Header Title -->
	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown has-arrow main-drop">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<a class="dropdown-item" href="{$zBasePath}cv2/mon_cv">Mon CV</a>
	...
	<div class="dropdown mobile-user-menu">
		...
		<div class="dropdown-menu dropdown-menu-right">
			<a class="dropdown-item" href="{$zBasePath}cv2/mon_cv">Monfff CV</a>
			<a class="dropdown-item" href="{$zBasePath}gcap/deconnexion">Déconnexion</a>
			<a class="dropdown-item" href="{$zBasePath}user/change_password">Changer Mot de passe</a>
		</div>
	</div>
