...
{/if}
{else}
<body style="background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.6)), url({$zBasePath}assets/common/img/rano.jpg);background-position:left;background-attachment: fixed;">
{/if}
