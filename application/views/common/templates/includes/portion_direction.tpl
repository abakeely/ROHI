...
<div>
	<div class="">
			<div class="field" style="font-size:14px;color:green;">
				<label>&nbsp;</label>
				Service :&nbsp; <input class="interchangeableDir" id="iRattacheDir" name="iRattacheDir" checked="checked" value="1" type="radio">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				Direction :&nbsp; <input class="interchangeableDir" id="iRattacheDir" name="iRattacheDir" value="0" type="radio">
				<p>&nbsp;</p>
			</div>
	</div>
</div>
<div id="serviceRattacheDir">
	<div class="field">
		<label>Service</label>
...
<div id="directionRattacheDir" style="display:none">
	<div class="field">
		...
		<select class="form-control notSurDir" placeholder="Direction" name="direction" onChange="getLocaliteAffiche('{$zBasePath}',23,this.value);" data-toggle="tooltip" data-original-title= "Safidio ny Foibem-pitondrana misy anao " id="iDirectionId1">
			...
			{foreach from=$toDirection item=$oDirection }
				<option value="{$oDirection.id}">{$oDirection.libele}</option>
			{/foreach}
		</select>
		<p class="message debut" style="width:500px">&nbsp;</p>
	</div>
