...
<div>
	<div class="">
			<div class="field" style="font-size:14px;color:green;">
				<label>&nbsp;</label>
				Service :&nbsp; <input class="interchangeableDir" id="iRattacheDir" name="iRattacheDir"  value="1" type="radio">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				Direction :&nbsp; <input class="interchangeableDir" id="iRattacheDir" name="iRattacheDir" checked="checked" value="0" type="radio">
				<p>&nbsp;</p>
			</div>
	</div>
</div>
<div id="serviceRattacheDir" style="display:none">
	<div class="field">
		<label>Service</label>
