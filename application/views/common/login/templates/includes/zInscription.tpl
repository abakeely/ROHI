<form class="form-horizontal form_inscription form-signup hide" role="form" name="create_form"  id="create_form" action="{$zBasePath}user/create" method="POST">
	...
	<div class="panel panel-danger">
		<div class="panel-body">
			...
			<select id="Genre" class="form-control" name="sexe" placeholder="Genre" required autofocus>
				<option value="" selected>Genre</option>
				<option {if $zSexeEdit==1}selected="selected"{/if} value="1">Masculin</option>
				<option {if $zSexeEdit==2}selected="selected"{/if} value="0">Feminin</option>
			</select>
			<br>
			<div>
		...
		<div class="panel-footer">
			<div class=" text-center">
				<a href="#" class="showSignIn"><span class="la la-sign-in"></span>Déja inscrit, Se connecter</a>
			</div>
		</div>
	</div>
</form>
