<form class="form-signin show" id="div_form_login" action="{$zBasePath}user/connect" onsubmit="return validerForm()" method="post">
	<div class="panel panel-danger">
		...
		<div class="panel-footer">
			<div>
				<a href="{$zBasePath}assets/pdf/MANUEL_D_UTILISATION.pdf" target="_blank"><span class="la la-file-pdf-o text-danger"></span> <small>Télécharger ici le manuel d'utilisation ROHI</small></a>
			</div>
			<div>
				<a href="{$zBasePath}assets/pdf/DECRET.pdf" target="_blank"><span class="la la-file-code-o text-danger"></span> <small>Code de Déontologie de l'Administration et de bonne Conduite des agents de l'état</small></a>
			</div>
		</div>
	</div>
</form>