				...
				<div class="row1">
					<div class="cell small">
						<div class="field">
							...
							<input type="text" name="date_debut" id="date_debut" value="{$oData.zDateDebut}" placeholder="s&eacute;l&eacute;ctionner la date de d&eacute;but" class="form-control datedropper-range-fiche obligatoire">
				...
				<div class="row1 {if $oData.iCompteActif == COMPTE_AGENT}clearfix{/if}">
					<div class="cell small">
						<div class="field">
							...
							<input type="text" name="date_fin" id="date_fin" value="{$oData.zDateFin}" placeholder="s&eacute;l&eacute;ctionner la date fin" class="form-control datedropper-range-fiche obligatoire">
		...
		<table>
			...
			<tbody>
				...
				<tr {if $iIncrement%2 == 0} class="even" {/if}>
					<td>{$oListeTransaction.CHECKTIME|date_format:"%A"|ucfirst}</td>
					<td>{$oListeTransaction.CHECKTIME|date_format:"%d/%m/%Y"}</td>
					<td>{$oListeTransaction.CHECKTIME|date_format:"%H:%M:%S"}</td>
