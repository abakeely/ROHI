			...
			{include_php file=$zHeader}
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col-12">
								<h3 class="page-title">Visiteurs > Liste</h3>
								{* <ul class="breadcrumb">
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="card-body">
								<form action="{$zBasePath}sau/visiteurs/gestion-visiteur/ajout" method="POST" name="formulaireTransaction" id="formulaireTransaction"  enctype="multipart/form-data">
									<fieldset>
										<div class="row1">
											<div class="cell small">
												<button class="dialog-link">Ajouter une visite</button>
											</div>
										</div>
									</fieldset>
								</form>
