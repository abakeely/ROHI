											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<!----------------->
														...
														<div style="position: absolute;float: right;right: 16px;width: 35%;">
															<div class="widget-box widget-color-dark">
																...
																<div class="form-actions center" style="margin-bottom:0px;">
																	<button class="btn btn-inverse btn-primary ajoutPorte" style="width:50%;outline:none">
																		<i class="ace-icon la la-pencil align-top "></i>
																		<span>Ajout porte</span>
																	</button>
																	</br></br>
																	<button class="btn btn-inverse btn-primary ajoutBadge" style="width:50%;outline:none">
																		<i class="ace-icon la la-pencil align-top"></i>
																		<span>Ajout Badge</span>
																	</button>
																</div>
															</div>
														</div>
													...
													<div class="widget-main">
														...
														<div class="control-group">
															<div class="bootstrap-colorpicker" > 
																<input  style="width: 50%;text-transform:uppercase!important;" type="text" id="visiteur_nom" name="visiteur_nom" class="input-small" />
