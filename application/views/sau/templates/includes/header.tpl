...
<head>
    ...
    <title>{if $oModuleActifTitle.module_id == 7}ROHI - titre de paiement{else}ROHI - Service d'accueil{/if}</title>
	{/foreach}
	
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/bootstrap.min.css" />

	<!-- page specific plugin styles -->

	<!-- text fonts -->
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/fonts.googleapis.com.css" />

	<!-- ace styles -->
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/ace1.css" class="ace-main-stylesheet" id="main-ace-style" />

	<!--[if lte IE 9]>
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/ace-part2.min.css" class="ace-main-stylesheet" />
	<![endif]-->
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/ace-skins.min.css" />
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/ace-rtl.min.css" />
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/jquery.alerts.css" />
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/blue.css">

	<!--[if lte IE 9]>
	<link rel="stylesheet" href="{$zBasePath}assets/sau/css/ace-ie.min.css" />
	<![endif]-->
    ...
    <link rel="stylesheet" type="text/css" href="{$zBasePath}assets/sau/app/css/app/app.css?2017">
