				...
				<form class="form-horizontal div_form_login" id="div_form_login" action="<?php echo base_url();?>user/connect" method="POST">
                      ...
                      <div class="row">
							<div class="col-md-12" style="text-align: center;color:black">
	                             Changement de pseudo et mot de passe<br>
	                             <a style="color:#0054da;" onclick="changePassword()" href="#" >Cliquer ici</a>	
							</div>		
                      		<!--<div class="col-md-12" style="text-align: center;">
                     			<a style="color:#428bca;" href="#" onclick="changePassword()"><font size="2rem">Pseudo ou mot de passe oubli&eacute; ?</font></font></a>
				  	  		</div>-->
				  	  </div>
                      <br>
                      <div class="row" >
							<div class="col-md-12" style="text-align: center;color:black">
	                             ...
	                             <a style="color:#0054da;" onclick="clickCreerCompte()" href="#" >Cr&eacute;er un compte</a>	
							</div>			
					 </div>
					 <br>
					 <div class="item active" style="text-align:center;">
                           ...
                           <br>
                           <a style="color:#0054da;" href="<?php echo base_url();?>assets/pdf/MANUEL_D_UTILISATION.pdf">Veuillez cliquer ici pour telecharger <br>le "Manuel d'utilisation ROHI"</a><br><br>
						   <a style="color:#0054da;" href="<?php echo base_url();?>assets/pdf/DECRET.pdf">Code de Déontologie de l´Administration et de bonne conduite des agents de l´Etat</a>
                     </div>
                  </form>
                  <br>
			</div>
