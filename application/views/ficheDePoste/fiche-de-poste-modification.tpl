...
<input type="hidden" name="iRedirect" id="iRedirect" value="1">
...
<div class="title">
	<h6>{if $toGetUserFichePoste.0.nom ==""} Ajout {/if}fiche de poste de : {if $toGetUserFichePoste.0.nom !=""}{$toGetUserFichePoste.0.nom|ucfirst}&nbsp;&nbsp;{$toGetUserFichePoste.0.prenom|ucfirst}{/if}</h6>
</div> 
