		...
		<form action="{$zBasePath}gcap/save/gestion-absence/demande" method="POST" name="formulaireEdit11" id="formulaireEdit11" enctype="multipart/form-data">
			...
			<div class=" clearfix">
				<div class="cell small" style="width:33%!important;">
					<div class="field">
						<label>Date d&eacute;but *</label>
						<input type="text" name="date_debut" class="form-control" id="date_debut" data-dd-opt-format="dd/mm/y" data-dd-opt-default-date="{$smarty.session.zDateToDayDefault}" data-dd-opt-double-view="true" autocomplete="off" value="" placeholder="s&eacute;l&eacute;ctionner la date de d&eacute;but" class="datedropper-range-fiche obligatoire" onchange="setDateFin(this.value)">
				...
				<div class="cell small" style="width:33%!important;">
					<div class="field">
						...
						<input type="text" name="date_fin" class="form-control" id="date_fin" data-dd-opt-format="dd/mm/y" data-dd-opt-default-date="{$smarty.session.zDateToDayDefault}" autocomplete="off" value="" placeholder="s&eacute;l&eacute;ctionner la date fin" class="datedropper-range-fiche obligatoire">
						<p class="message fin" style="width:500px">Veuillez cliquer ci-dessus pour s&eacute;l&eacute;ctionner la date fin</p>
					</div>
				</div>
				<div class="cell small" style="display:inline;width:33%!important;">
					<div class="field">
						 <label>&nbsp;</label>
						<select id="matinSoir" name="matinSoir" class="form-control obligatoire" style="width: 100px;">
							<option selected="selected" value="1">Matin</p>
							<option selected="selected" value="2">Apr&eacute;s-midi</p>
						</select>
						<p class="check"><input type="checkbox" id="iDemiJournee"  name="iDemiJournee" value="1"><label>0,5 Jour </label>
						</p>
			...
			<div class=" clearfix">
				<div class="cell">
					<div class="field">
						...
						<input type="text" class="form-control" name="gcap_interim" id="gcap_interim"   style="width:300px!important">
						<p class="message interim" style="width:500px">Veuillez mentionner le nom de votre int&eacute;rim</p>
					</div>
				</div>
			</div>
			<div class=" clearfix">
