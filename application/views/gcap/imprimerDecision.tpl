...
<body>
	...
	<p class="prt" style="text-align:right;margin-right:340px;">Decision n° {if $oData.oDecision.decision_numero != 0}{$oData.oDecision.decision_numero}-{$oData.oDecision.decision_annee}{else}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{/if} MFB{if $oData.sigle!=""}/{/if}{$oData.sigle} {if $oData.oDecision.decision_numero != 0}du {$oData.oDecision.decision_dateValidation|date_format|utf8}{/if}</p>
    ...
    <div class="inner">
        ...
        <div class="row clearfix">
            <div class="col end">
                ...
                <div class="last">
                    <p class="center"><strong>Sigrnature de: {if $oData.oDecision.decision_autoriteSaisi != ""}{$oData.oDecision.decision_autoriteSaisi}{else}{if $oData.oCandidat.id != $oData.oSignataire.0->id}{if $oData.oSignataire.0->nom != ""}{$oData.oSignataire.0->nom}&nbsp;{$oData.oSignataire.0->prenom}{/if}{/if}{/if}</strong></p>
                </div>
            </div>
        </div>
    </div>
