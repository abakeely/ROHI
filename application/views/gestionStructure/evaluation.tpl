	...
	<table>
		 <tbody>
			<tr>
			   ...
			   <td>Montant 563 [[data.date_interval_0]]&nbsp;&nbsp;:&nbsp;&nbsp;  <b style="font-weight:bold;">[[data.montant_563_0]] Ar</b></td>
			...
			<tr>
			   ...
			   <td>Montant 563 [[data.date_interval_1]]&nbsp;&nbsp;:&nbsp;&nbsp;  <b style="font-weight:bold;">[[data.montant_563_1]] Ar</b></td>
			   <td><b style="font-weight:bold;">&nbsp;</td>
			</tr>
			<tr>
			   ...
			   <td>Montant 563 [[data.date_interval_2]]&nbsp;&nbsp;:&nbsp;&nbsp;  <b style="font-weight:bold;">[[data.montant_563_2]] Ar</b></td>
			   <td>&nbsp;</td>
			</tr>
