<?php 
	...
	/*Modif Stage et formation professionnelle de courte durée*/
	$temp3 = array('stage_name'=>'','stage_etablissement'=>'','stage_annee'=>'','stage_pays'=>'');
	$stage_list = array(0=>$temp3);
	/*Fin Stage et formation professionnelle de courte durée*/
	...
	<div class="col-md-8">
	    <div class="row">
			<div class="col-md-2" style="background: none;z-index:9"> 
				<img src="<?php echo $image_url;?>" style="width:150px;border-radius: 81px;height:150px;border: 5px solid #DBA988;z-index: 999;object-fit: cover;"/>
			</div>
			<div class="col-md-10 div_info_profil">
				<div class="row" style="background: #E2DDD7;border-radius: 13px;height: 93px;border: solid #DBA988;">
					<div class="col-md-12 libele_form" style="text-align: left;margin-left: 101px;">
...
<div class="row" style="height: 14em;margin-right: -4px;">
	<div class="col-md-6">
		...
		<div class="row"><br></div>
		<!--------------------------------------> 
		<div class="row separateur separateur1" id="div_loisirs" onclick="showClass('div_loisirs')"><div class="col-md-10" id="icon_div_loisirs"><i class="la la-angle-down"></i>&nbsp;Loirs et Activités Annexes</div></div>
	...
	<div class="col-md-6">
		...
		<div class="row div_etat_civil">
			...
			<div class="col-md-5">
					<input type="text" id="date_naiss" class="form-control" style="border: 1px solid #70AAA3 !important;"  placeholder="Date de Naissance" name="date_naiss" value="<?php echo $date_naiss;?>" >
		...
		<div class="row div_etat_civil">
			...
			<div class="col-md-5">
				<select class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="Situation Matrimoniale" name="sit_mat" data-toggle="tooltip" data-original-title= "Hamarino ny momba anao : Manambady, na Misaraka, na Mpitovo, na Maty Vady"id="sit_mat" onchange="changeDest()">
		...
		<div class="row div_etat_civil">
			...
			<div class="col-md-5">
				<input type="text" id="nbr_enfant"  style="border: 1px solid #70AAA3 !important;" style="width:45px;" maxlength="2" class="form-control" name="nbr_enfant" data-toggle="tooltip" data-original-title= " Soraty ny isan’ny ankizy"value="<?php echo $nbr_enfant;?>">
			</div>
		</div>
		<!-- FIN DIV ETAT CIVIL -->
  ...
  <div class="col-md-12">
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none;">
				<input type="text" class="form-control" placeholder="Poste" style="border: 1px solid #70AAA3 !important;" name="poste" data-placement="top" data-toggle="tooltip" data-original-title="Soraty ny asa amandrarahanao"  id="poste" value="<?php echo $poste; ?>">
			</div>
		</div>
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
					<select class="form-control" placeholder="Status" style="border: 1px solid #70AAA3 !important;" name="statut" data-placement="top" <?php if ((string)$user_edit['statut'] != '0') echo 'disabled="disabled"' ;?> data-toggle="tooltip" data-original-title="Hamarino ny momba anao na ECD, na ELD, na EMO, na ES, na EFA, na Fonctionnaire"id="statut">
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
							<select id="corps" class="form-control" placeholder="Status" style="border: 1px solid #70AAA3 !important;" name="corps" <?php if ((string)$corps_edit != '0') echo 'disabled="disabled"' ;?> data-placement="top" data-toggle="tooltip" data-original-title="Raha tsy mivoaka ny « corps »-nao dia mila misafidy ianao">
							<?php
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
					<select class="form-control" placeholder="Status" style="border: 1px solid #70AAA3 !important;" name="grade" <?php if ((string)$grade_edit != '0') echo 'disabled="disabled"' ;?> data-placement="top" data-toggle="tooltip" data-original-title="Raha tsy mivoaka ny « Grade »-nao dia mila misafidy ianao" id="grade">
							<?php 
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
					<select class="form-control" placeholder="Status" style="border: 1px solid #70AAA3 !important;" name="indice" <?php if ((string)$indice_edit != 0) echo 'disabled="disabled"' ;?>  data-placement="top" data-toggle="tooltip" data-original-title="Raha tsy mivoaka ny « Indice »-nao nao dia mila misafidy ianao" id="indice">
							<?php 
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" id="date_prise_service_div" style="background:none; ">
					<input type="text" id="date_prise_service" class="form-control" placeholder="Date de prise de service" style="border: 1px solid #70AAA3 !important;" data-placement="top" data-toggle="tooltip" data-original-title="Ampidiro ny  andro/volana/taona  nidiranao niasa teto amin’ny Ministeran’ny Fitantanambola sy ny Teti-bola" name="date_prise_service" value="<?php echo $date_prise_service;?>"/>
					<span class="la la-calendar txt-danger form-control-feedback" style="top:11px;right:12px;"></span>
			</div>
		</div>
		...
		<!--<div class="row div_info_admin"><br></div>
			...
			<div class="col-md-3" style="background:none; ">
				<input type="text" class="form-control" placeholder="Fonction actuelle" style="border: 1px solid #70AAA3 !important;" name="poste" data-placement="top" data-toggle="tooltip" data-original-title="Soraty ny asa amandrarahanao"  id="poste" value="<?php echo $poste; ?>">
			</div>
		</div>-->
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
				<textarea name="domaine" id="domaine" style="border: 1px solid #70AAA3 !important;" class="form-control" rows=5  data-toggle="tooltip" data-original-title= "Soraty ireo karazana traikefa hafa voafehinao"><?php echo $domaine_edit;?></textarea>
			</div>
		</div>
		<!--
		<div class="row div_info_admin"><br></div>
		...
		<div class="col-md-1"></div>
			...
			<div class="col-md-3" style="background:none; ">
				<textarea name="autre_domaine" id="autre_domaine" style="border: 1px solid #70AAA3 !important;" class="form-control" rows=5  data-toggle="tooltip" data-original-title= "Soraty  raha manana traikela lanampiny ianao"><?php echo $autre_domaine_edit;?></textarea>
			</div>
		</div>
		-->
		<div class="row div_info_admin"><br></div>
		<div class="row div_info_admin">
			...
			<div class="col-md-5" >
				...
				<tr id="row_activite_<?php echo $i;?>">
					<?php if($i!=1) { echo "<br>"; }?>
						<td style="padding:2px;width:90%"><input type="text" style="border: 1px solid #70AAA3 !important;" class="form-control" placeholder="Activit&eacute;" name="activite[]" data-placement="top" data-toggle="tooltip" data-original-title="Soraty ny asa amandrarahanao"  value="<?php echo $activite['libele'];?>"></td>
				    <?php if($i!=1){?> 
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-2">
				<button style="background: none repeat scroll 0px 0px #DBA988;color:white; border: 1px none !important;" type="button" class="form-control" id="ajoutActivite" data-toggle="tooltip" data-original-title= "Tsindrio ra hanampy ny asa efa nosahaninao hatramin’izay" >Ajouter une activit&eacute;</button>
			</div>
			<div class="col-md-5"></div>
		</div>
		...
		<div class="row div_info_admin">
				<div class="col-md-2"></div>
					<div class="col-md-3 libele_form" style="background:none; ">
						<label class="control-label ">Localité de Service<b><font color='#DBA988'> * </font></b> </label>
					</div>
		</div>
		...
		<div class="row div_info_admin">
			<div class="col-md-2"></div>
				<div class="col-md-3 libele_form" style="background:none; "></div>
				<div class ="col-md-5">
				</div>
			<div class="col-md-5">
				<input type="radio" value="0" name="radioLocalite"  onclick="showDivCV()"/> Département d'origine
				<input type="radio" value="1" name="radioLocalite"  onclick="hideDivCV()"/> Mise à disposition
				
			</div>
		</div>
		<div class="row div_info_admin clickMFB">
				<div class="col-md-2"></div>
					<div class="col-md-3 libele_form" style="background:none; "></div>
			<div class ="col-md-5">
			<div class="col-md-5">
				<input type="radio"  value="1" name="radioMFB" onclick="clickMFB()"/> MFB&nbsp;&nbsp;
				<input type="radio"  value="0" name="radioMFB" onclick="clickNonMFB()"/> Autres (Institutions / Ministères)
			</div>
		</div>
		<div id="div_cv">
		<div class="row div_info_admin ministere"><br></div>
		<div class="row div_info_admin ministere">
		  <div class="col-md-2"></div>
		   <div class="col-md-3 libele_form" style="background:none; ">
			  <label class="control-label "> Ministere </label><font color="#DBA988"> </font></b>
		   </div>
			  <div class="col-md-3" style="background:none; ">
				   <select id="ministere" class="form-control">
						<option>M2PAT</option>
						<option>FOP</option>
						<option>MEN</option>
						<option>MENSUP</option>
				   </select>
			  </div>
		</div>
		<br>
		...
		<div class="row div_info_admin">
		  <div class="col-md-2"></div>
		   <div class="col-md-3 libele_form" style="background:none; ">
			  ...
			  <div class="col-md-3" style="background:none; ">
				   <select <?php echo $zDisabled; ?> class="form-control" placeholder="pays" style="border: 1px solid #70AAA3 !important;" name="pays" data-placement="top" data-toggle="tooltip" data-original-title="Safidio ny anarany ilay firenena nahazoanao ilay mari-pahaizana"id="pays">
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
				<select <?php echo $zDisabled; ?> class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="province" name="province" data-toggle="tooltip" data-original-title="Safidio ny Faritany misy anao"  id="province">
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
					<select <?php echo $zDisabled; ?> class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="Region" name="region"  data-toggle="tooltip" data-original-title="Safidio ny Faritra misy anao" id="region" <?php /*if($user_edit['role']=="chef")echo 'disabled="disabled"';*/?>>
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
				<select <?php echo $zDisabled; ?> class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="district" name="district" data-placement="top" data-toggle="tooltip" data-original-title="safidio ny Distrika misy anao" id="district">
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
				<select <?php echo $zDisabled; ?> class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="Departement" name="departement" data-toggle="tooltip" data-original-title= "Safidio ny Departemanta na sampan-draharaha misy anao" id="departement"<?php if($user_edit['role']=="chef");?>>
					<option  value="0">-------</option> 
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
				 <select <?php echo $zDisabled; ?> class="form-control" placeholder="Direction" name="direction" data-toggle="tooltip" data-original-title= "Safidio ny Foibem-pitondrana misy anao " id="direction" <?php if($user_edit['role']=="chef");?>>
					<option  value="0">-------</option> 
		...
		<div class="row div_info_admin">
			...
			<div class="col-md-3" style="background:none; ">
				<select <?php echo $zDisabled; ?> class="form-control" placeholder="Service" name="service" data-toggle="tooltip" data-original-title= "Safidio  ny sampan-draharaha  misy anao " id="service" <?php if($user_edit['role']=="chef");?>>
					<option  value="0">-------</option> 
			...
			<table class="tableau" id="tableDiplome">
				<tbody>
					...
					<tr id="diplome_row_<?php echo $i;?>">
						<td><input class="form-control" placeholder="Diplomes" type="text" name="diplome_name[]" value="<?php echo $diplome['diplome_name'];?>" data-toggle="tooltip" data-original-title= "Soraty ny mari-pahaizana ambony azonao farany"/></td>
						<td><input class="form-control" placeholder="Fili&egrave;re" type="text" name="diplome_discipline[]" value="<?php echo $diplome['diplome_disc'];?>" data-toggle="tooltip" data-original-title= "Soraty ny sampam-pianarana"/></td>
						<td><input class="form-control input_date"  maxLength="4"  id="diplome_date_<?php echo $i;?>" onChange="testDate('<?php echo $i;?>')" placeholder="Ann&eacute;e d&grave;obtention" type="text" name="diplome_date[]" value="<?php echo $diplome['diplome_date'];?>" data-toggle="tooltip" data-original-title= "Soraty ny taona nahazoanao ilay mari-pahaizana"/></td>
						<td><input class="form-control " placeholder="Etablissement " type="text" name="diplome_etablissement[]" value="<?php echo $diplome['diplome_etab'];?>" data-toggle="tooltip" data-original-title= "Soraty ny toeram-pianarana nahazoanao ilay mari-pahaizana"/></td>
						<td><input class="form-control" placeholder="Pays" type="text" name="diplome_pays[]" value="<?php echo $diplome['diplome_pays'];?>" data-toggle="tooltip" data-original-title= "Soraty ny anaran'ilay firenena nahazoanao ilay mari-pahaizana"/></td>
				...
				<tbody>
					<tr>
						<td>
							...
							<label style="font-size: 14px; font-family: Lato; font-size:13px;" class="control-label libele_form">Stage et formation professionnelle de courte durée <b><font color='#DBA988'> * </font></b> </label>   
						</td>
					</tr>
					</tbody>
			</table>
			<table class="tableau" id="tableStage">
				<tbody>
					...
					<tr id="stage_row_<?php echo $i;?>">
						...
						<?php if($i!=1){ ?>
						<td style="width:15px!important"><button class="btn_close" type="button" onclick="<?php echo 'deleteStage('.$i.')';?>"><i class="la la-minus-circle"></i></button></td>
						<?php } ?>
					</tr>
					<?php }?>
				</tbody>
		...
		<div class="row div_formation">
			<div class="col-md-9"></div>
			<div class="col-md-2">
				<button style="background: none repeat scroll 0px 0px #98B6B4;color:white; border: 1px none !important;" type="button" class="form-control" data-toggle="tooltip" data-original-title= "Tsindrio ra hanampy diplaoma" id="ajoutStage"> Ajouter Formation</button>
			</div>
			<div class="col-md-1"></div>
		</div>
			...
			<table class="tableau"  id="tableParcours">
				<tbody>
					...
					<tr id="parcours_row_<?php echo $i;?>">
						<td>&nbsp;</td>
						<td><input class="form-control input_date"maxLength="4" style="border: 1px solid #70AAA3 !important;" id="date_debut_<?php echo $i;?>" onChange="testDate('<?php echo $i;?>')" placeholder="Ann&eacute;e / D&eacute;but" type="text" name="date_debut[]" value="<?php echo $parcours['date_debut'];?>" data-toggle="tooltip" data-original-title= "Soraty ny taona nanombohanao niasa tao amin'ny sampan-draharaha"/></td>

						<td><input class="form-control input_date" maxLength="4" style="border: 1px solid #70AAA3 !important;"  id="date_fin_<?php echo $i;?>" onChange="testDate('<?php echo $i;?>')" placeholder="Ann&eacute;e / Fin" type="text" name="date_fin[]" value="<?php echo $parcours['date_fin'];?>" data-toggle="tooltip" data-original-title= "Soraty ny taona farany niasanao tao amin'ny sampandraharaha"/></td>

						<td><input class="form-control" placeholder="Poste" style="border: 1px solid #70AAA3 !important;" type="text" name="par_poste[]" value="<?php echo $parcours['par_poste'];?>" data-toggle="tooltip" data-original-title= "Soraty ny asa na andraikitra nosahaninao"/></td>

						<td><input class="form-control" placeholder="Departement" style="border: 1px solid #70AAA3 !important;" type="text" name="par_departement[]" value="<?php echo $parcours['par_departement'];?>" data-toggle="tooltip" data-original-title= "Soraty ny Departemanta na sampan-draharaha  misy anao"/></td>

						<?php if($i!=1){ ?>
						<td style="width:15px!important;"><button class="btn_close" type="button" onclick="<?php echo 'deleteParcours('.$i.')';?>"><i class="la la-minus-circle"></i></button></td>
						<?php } ?>
					</tr>
					<?php }?>
					</tbody>
		...
		<div class="row div_parcours">
			<div class="col-md-9"></div>
			<div class="col-md-2">
					<button style="background: none repeat scroll 0px 0px #DBA988;color:white; border: 1px none !important;" type="button" class="form-control" id="ajoutParcours" data-toggle="tooltip" data-original-title= "Tsindrio ra hanampy ny asa efa nosahaninao hatramin’izay" >Ajouter un parcours</button>
				</div>
			<div class="col-md-1"></div>
		</div> 
		<!-- FIN DIV PARCOURS -->
		...
		<!-- DIV LOISIRS ANNEXES -->
		<div class="row div_loisirs"><br></div>
		<div class="row separateur separateur1 div_loisirs" style="background:#DBA988!important"><div class="col-md-12">Loisirs et Acitivités Annexes</div></div>
		<div class="row div_loisirs"><br></div>
		<div class="row  div_loisirs">
			<div class="col-md-1"></div>
				<div class="col-md-3 libele_form" style="background:none; ">
					<label class="control-label ">Loisirs <b><font color='#DBA988'> * </font></b> </label>
				</div>
			<div class="col-md-5" >
				<table id="table_loisir">
				<?php $i=0; foreach($activite_list as $activite){$i++;?>
				<tr id="row_activite_<?php echo $i;?>">
					<?php if($i!=1) { echo "<br>"; }?>
						<td style="padding:2px;width:90%"><input type="text" style="border: 1px solid #70AAA3 !important;" class="form-control" placeholder="Loisirs" name="loisir[]" data-placement="top" data-toggle="tooltip" data-original-title="Soraty ny asa amandrarahanao"  value=""></td>
				    <?php if($i!=1){?> 
                    <td><button class="form-control btn_close" type="button" onclick="<?php echo 'deleteLoisir('.$i.')';?>"><i class="la la-minus-circle"></i></button>   
                    <?php }?></td>
				</tr>
				<?php }?>
				</table>
		...
		<div class="row div_loisirs">
			...
			<div class="col-md-2">
				<button style="background: none repeat scroll 0px 0px #DBA988;color:white; border: 1px none !important;" type="button" class="form-control" id="ajoutActivite" data-toggle="tooltip" data-original-title= "Tsindrio ra hanampy ny asa efa nosahaninao hatramin’izay" >Ajouter loisir</button>
			</div>
			<div class="col-md-5"></div>
		</div>
		...
		<div class="row  div_loisirs">
			<div class="col-md-1"></div>
				<div class="col-md-3 libele_form" style="background:none; ">
					<label class="control-label ">Activités Annexes <b><font color='#DBA988'> * </font></b> </label>
				</div>
			<div class="col-md-5" >
				<table id="table_loisir">
				<?php $i=0; foreach($activite_list as $activite){$i++;?>
				<tr id="row_activite_<?php echo $i;?>">
					<?php if($i!=1) { echo "<br>"; }?>
						<td style="padding:2px;width:90%"><input type="text" style="border: 1px solid #70AAA3 !important;" class="form-control" placeholder="Activités Annexes" name="loisir[]" data-placement="top" data-toggle="tooltip" data-original-title="Soraty ny asa amandrarahanao"  value=""></td>
				    <?php if($i!=1){?> 
                    <td><button class="form-control btn_close" type="button" onclick="<?php echo 'deleteLoisir('.$i.')';?>"><i class="la la-minus-circle"></i></button>   
                    <?php }?></td>
				</tr>
		...
		<div class="row  div_cordonne">
			...
			<div class="col-md-3" style="background:none; ">
				<input type="text" id="addresse" class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="Adresse" name="addresse" data-toggle="tooltip" data-original-title= "Soraty ny toeram-ponenao ankehitriny" id="sit_mat"value="<?php echo $adress;?>">
			</div>
		...
		<div class="row div_cordonne">
			...
			<div class="col-md-3" style="background:none; ">
				<input type="text" id="phone" class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="T&eacute;l&eacute;phone" name="phone" data-toggle="tooltip" data-original-title= "Ampidiro ny laharan'ny finday anao (iray ihany)" value="<?PHP ECHO $phone;?>">
			</div>
		</div>
		...
		<div class="row div_cordonne">
			...
			<div class="col-md-3" style="background:none; ">
				<input type="text" id="email" class="form-control" style="border: 1px solid #70AAA3 !important;" placeholder="E-mail" name="email" data-toggle="tooltip" data-original-title= "Ampidiro ny mailaka" value="<?php echo $email;?>">
			</div>
		</div>
		<!-- DIV CORDONNE -->
	
	<!-- <div>  </div>-->
	<!-- modification lucia helisoa -->
<br>
<div class="row" style="margin-left: 215px; background:none;">
	
	<div class="col-md-3">
			<input type='submit' class="btn btn-primary form-control " style="background-color:#DBA988; border: 1px none !important" data-toggle="tooltip" data-original-title=" Tsindrio rehefa feno daholo ny momba anao rehetra " value='Enregistrer' />	
	</div>
	
<?php if($user_edit['exist_cv']){ ?>
	<div class="col-md-3">
		<a href="#" class="btn btn-primary form-control " style="background-color:#DBA988; border: 1px none !important; ;padding: 8px 0px !important;" data-toggle="tooltip" data-original-title=" Tsindrio dia afaka manonta ny mari-pankasitrahanao"  onclick="certificat(<?php if(isset($edit_cv)) echo $candidat->id;?>)"> <font style="font-size: 1em;"> Imprimer attestation</font></a>
	</div>
<?php } ?>
<?php if($user_edit['exist_cv']){ ?>
	<div class="col-md-3">
		<a href="<?php echo base_url();?>cv/fpdf_cv/<?php if(isset($edit_cv)) echo $candidat->id;?>" class="btn btn-primary form-control " style="background-color:#DBA988; border: 1px none !important; ;padding: 8px 0px !important;" data-toggle="tooltip" data-original-title=" Tsindrio dia afaka manonta ny CV'nao ianao" target="_blank" > <font style="font-size: 1em;"> Imprimer CV </font></a>
	</div>
<?php } ?>
</div>
</form> 
