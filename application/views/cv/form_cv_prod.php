...
?>
 ...
 <div id="content-wrap" class="row"> 
  ...
  <?php 
	...
	/*foreach ($toComptes as $oComptes) {
		if ($oComptes['compte_id'] != COMPTE_ADMIN) {
			$zDisabled = ' disabled="disabled" ';
			echo '<input type="hidden" name="departement1" id="departement1" value="'.$departement_edit.'">  ';
			echo '<input type="hidden" name="direction1" id="direction1" value="'.$direction_edit.'">  ';
			echo '<input type="hidden" name="service1" id="service1" value="'.$service_edit.'">  ';
...
<!----------------- bloc Toogle ---------------->
	<div class="blocToggle">
			<div class="toggleBloc">
				<div class="row separateur separateur1"><div class="col-md-12">Informations Administratives</div></div>
			</div>
...
<!----------------- bloc Toogle ---------------->
		...
		<div class="blocToggle">
		<div class="toggleBloc">
		<div class="row separateur separateur1"><div class="col-md-12">Etat Civil</div></div></div>
		<div class="child" style="display: none;">
		<!----------------- bloc Toogle ---------------->
		
		
		<!--<div class="row separateur separateur1"><div class="col-md-12">Etat Civil</div></div>-->
		<br>
		<div class="row">
			<div class="col-md-1">
			</div>
		...
		<div class="blocToggle">
			<div class="toggleBloc">
				<div class="row separateur separateur1"><div class="col-md-12">Adresse et Contact</div></div></div>
			<div class="child" style="display: none;">
<!----------------- bloc Toogle ---------------->
          <!--<div class="row separateur separateur1"><div class="col-md-12">Adresse et Contact</div></div>-->
        <br>
		<div class="row">
			<div class="col-md-1">
			</div>
		...
		<!----------------- bloc Toogle ---------------->
			<div class="blocToggle">
					<div class="toggleBloc">
						<div class="row separateur separateur1"><div class="col-md-12">Formations</div></div></div>
					<div class="child" style="display: none;">
		<!----------------- bloc Toogle ---------------->
                <!--<div class="row separateur separateur1"><div class="col-md-12">Formations</div></div>-->
                <br>
		<?php /* ?>
		<div class="row">
			<div class="col-md-1">
			...
			<div class="col-md-9">
                            <div class="row" >
                                <div class="col-md-12" id="tableDiplome1">
			...
			<table class="tableau">
				<tbody>
					<tr>
						<td>
							<input type="hidden" value="<?php echo sizeof($diplome_list)?>" id="size_diplome"/>   
							<label style="font-size: 14px;" class="control-label libele_form">Dipl&ocirc;mes Obtenus (Commencer par le plus r&eacute;cent) <b><font color='red'> * </font></b> </label>   
						</td>
					</tr>
					</tbody>
			</table>
		...
		<div class="row">
			...
			<div class="col-md-7" > <u>Exemples</u>:
		...
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-7" > <u>Exemple </u>:
                            permis de conduire ,
		...
		<div class="blocToggle">
		<div class="toggleBloc">
			<div class="row separateur separateur1"><div class="col-md-12">Parcours professionnel</div></div></div>
		<div class="child" style="display: none;">
<!----------------- bloc Toogle ---------------->
		<!--<div class="row separateur separateur1"><div class="col-md-12">Parcours professionnel</div></div>-->
		<br>
		<div class="row">
			<div class="col-md-1">
			</div>
	...
	<div class="row">
			...
			<div class="col-md-3 libele_form">
				<label class="control-label ">Activit&eacute; (Etudier les dossiers entrants) <b><font color='red'> * </font></b> </label>
			</div>
			<div class="col-md-6" >
				...
				<tr id="row_activite_<?php echo $i;?>">
					<?php if($i!=1) { echo "<br>"; }?>
						<td style="padding:2px;width:90%"><input type="text" class="form-control" placeholder="Activit&eacute;" name="activite[]" data-placement="top" data-toggle="tooltip" data-original-title="Soraty ny asa amandrarahanao"  value="<?php echo $activite['libele'];?>"></td>
					</div>
				    <?php if($i!=1){?> 
                    <td><button class="form-control btn_close" type="button" onclick="<?php echo 'deleteActivite('.$i.')';?>"><i class="la la-minus-circle"></i></button></div>    
                    <?php }?></td>
				</tr>
				<?php }?>
				</table>
		...
		<div class="row">
				...
				<div class="col-md-2">
							<button style="background: none repeat scroll 0px 0px olivedrab;color:white" type="button" class="form-control" id="ajoutActivite" data-toggle="tooltip" data-original-title= "Tsindrio ra hanampy ny asa efa nosahaninao hatramin’izay" >Ajouter une activit&eacute;</button>
						</div>
				<div class="col-md-5"></div>
		</div>  
		<br>
		...
		<div class="row">
			...
			<div class="col-md-3 libele_form">
				<input type="hidden" value="<?php echo sizeof($parcours_list)?>" id="size_parcours"/>   
				<label class="control-label">Parcours (Commencer par votre poste actuel)</label>
			</div>
		...
		<div class="row">
			<table class="tableau"  id="tableParcours">
				<tbody>
					<!--<tr>
						<th>Ann&eacute;e / D&eacute;but</th>
						<th>Ann&eacute;e / Fin</th>
						<th>Poste</th>
						<th>Departement</th>
						<th></th>
					</tr>-->
					...
					<tr id="parcours_row_<?php echo $i;?>">
						...
						<td><input class="form-control input_date" maxLength="4"  id="date_fin_<?php echo $i;?>" onChange="testDate('<?php echo $i;?>')" placeholder="Ann&eacute;e / Fin" type="text" name="date_fin[]" value="<?php echo $parcours['date_fin'];?>" data-toggle="tooltip" data-original-title= "Soraty ny taona farany niasanao tao amin'ny sampandraharaha"/></td>

						<td><input class="form-control" placeholder="Poste" type="text" name="par_poste[]" value="<?php echo $parcours['par_poste'];?>" data-toggle="tooltip" data-original-title= "Soraty ny asa na andraikitra nosahaninao"/></td>

						<td><input class="form-control" placeholder="Departement" type="text" name="par_departement[]" value="<?php echo $parcours['par_departement'];?>" data-toggle="tooltip" data-original-title= "Soraty ny Departemanta na sampan-draharaha  misy anao"/></td>
		...
		<div class="row">
          <div class="col-md-1"></div>
           <div class="col-md-3 libele_form">
              ...
              <div class="col-md-3">
                   <select <?php echo $zDisabled; ?> class="form-control" placeholder="pays" name="pays" data-placement="top" data-toggle="tooltip" data-original-title="Safidio ny anarany ilay firenena nahazoanao ilay mari-pahaizana"id="pays">
		...
		<div class="row">
                    ...
                    <div class="col-md-3">
                            <select <?php echo $zDisabled; ?> class="form-control" placeholder="province" name="province" data-toggle="tooltip" data-original-title="Safidio ny Faritany misy anao"  id="province">
								...
								<?php foreach($list_province as $province){ ?>
									<?php if($user_edit['exist_cv'] && $province_edit['id']==$province['id']){ ?>      
		...
		<div class="row">
                    ...
                    <div class="col-md-3">
                            <select <?php echo $zDisabled; ?> class="form-control" placeholder="Region" name="region"  data-toggle="tooltip" data-original-title="Safidio ny Faritra misy anao" id="region" <?php /*if($user_edit['role']=="chef")echo 'disabled="disabled"';*/?>>
								...
								<?php foreach($list_region as $region){ ?> 
									<?php if($user_edit['exist_cv'] && $region['id'] == $region_edit['id']){ ?>   
		...
		<div class="row">
                    ...
                    <div class="col-md-3">
                        <select <?php echo $zDisabled; ?> class="form-control" placeholder="district" name="district" data-placement="top" data-toggle="tooltip" data-original-title="safidio ny Distrika misy anao" id="district">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<select <?php echo $zDisabled; ?> class="form-control" placeholder="Departement" name="departement" data-toggle="tooltip" data-original-title= "Safidio ny Departemanta na sampan-draharaha misy anao" id="departement"<?php if($user_edit['role']=="chef");?>>
					<option  value="0">-------</option> 
		...
		<div class="row">
			...
			<div class="col-md-6" id="div_soa">
				<?php foreach($soa_list as $d){ ?>
					...
					<?php }*/ ?> 
					<!--else{?>  raha tiana avoka lay non enregistrer
		...
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-8" > <u>Exemple </u>:
                           P15 / BOX2 
			</div>					
		</div>
		<br>
		...
		<div class="row">
                ...
                <?php if($user_edit['exist_cv']){ ?>
                    <div class="col-md-2">
                        <a href="#" class="btn btn-primary form-control " data-toggle="tooltip" data-original-title=" Tsindrio dia afaka manonta ny mari-pankasitrahanao"  onclick="certificat(<?php if(isset($edit_cv)) echo $candidat->id;?>)"> <font style="font-size: 1em;"> Imprimer attestation</font></a>
                    </div>
		<?php } ?>
				<?php if($user_edit['exist_cv']){ ?>
                    <div class="col-md-2">
                        <a href="<?php echo base_url();?>cv/fpdf_cv/<?php if(isset($edit_cv)) echo $candidat->id;?>" class="btn btn-primary form-control " data-toggle="tooltip" data-original-title=" Tsindrio dia afaka manonta ny CV'nao ianao" target="_blank" > <font style="font-size: 1em;"> Imprimer CV </font></a>
                    </div>
		<?php } ?>
		</div>
        <br>
  ...
  <script>
    ...
    $(document).ready(function() {
		...
		/*$("#cv_form").submit(function(ev){ev.preventDefault();});*/
		/*$("input").on("click", function(){
		   ...
		   var bootstrapValidator = $("#cv_form").data('bootstrapValidator');
