														...
														<div id="EtatCivil" class="panel-collapse">
															<div class="panel-body">
																...
																<div class=" form form-group input-group">
																	<input type="text" id="date_naiss" data-dd-opt-format="dd/mm/y" data-dd-opt-default-date="{if $oCandidatCv->nom!=''}{$oCandidatCv->date_naiss|date_format2}{else}{$oUser.date_naiss|date_format2}{/if}" class="form-control" placeholder="Date de Naissance" name="date_naiss" value="{if $oCandidatCv->nom!=''}{$oCandidatCv->date_naiss}{else}{$oUser.date_naiss}{/if}" data-original-title="" title="" data-bv-field="date_naiss">
