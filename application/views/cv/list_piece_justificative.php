 ...
 <div id="content-wrap" class="row"> 
	<div class="col-md-12">
	<div class="row separateur"><div class="col-md-12"><i class="la la-hand-o-down" aria-hidden="true"></i> Statut</div></div>
	<br>
	...
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
		...
		<?php 
		$ordre = 0;
		foreach ($data_statut as $piece){ 
			$ordre++;
			
		?>  
		 <tr>
			<td><?php echo $ordre; ?></td>
			<td><?php echo $piece['date_operation']; ?></td>
			<td><?php echo  $piece['candidat_nom'];?></td>
			<td><?php echo $piece['resp_nom']; ?></td>
			<td><?php echo $piece['old_value']; ?></td>
			<td><?php echo  $piece['new_value'];?></td>
			<td><?php echo  $piece['piece'];?></td>
			<td><?php echo  $piece['portant'];?></td>
			<td><?php echo  $piece['numero'];?></td>
			<td><?php echo  $piece['date_operation'];?></td>
		 </tr>
		 <?php } ?>  
   </table>	
   ...
   <br>
	<div class="row separateur"><div class="col-md-12"><i class="la la-hand-o-down" aria-hidden="true"></i> Corps</div></div>
	<br>
	<div class="row"><div class="col-md-12">
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
	     <thead>
   ...
   <br>
	<div class="row separateur"><div class="col-md-12"><i class="la la-hand-o-down" aria-hidden="true"></i> Grade</div></div>
	<br>
	<div class="row"><div class="col-md-12">
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
	     <thead>
   ...
   <br>
	<div class="row separateur"><div class="col-md-12"><i class="la la-hand-o-down" aria-hidden="true"></i> Indice</div></div>
	<br>
	<div class="row"><div class="col-md-12">
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
	     <thead>
