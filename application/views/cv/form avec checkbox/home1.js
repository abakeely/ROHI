...
$(document).ready(function() {
        ...
        function ajouterDiplome(){
         ...
         function getRowTableActivite(index){
             var ret = '<div class="row row_activite" id="row_activite_'+index+'"><br>';
             ret += '<div class="col-md-10"><input class="form-control" placeholder="Activite" type="text" name="activite[]"/></div>';     
             ret += '<div class="col-md-2"><button class="form-control btn_close" type="button" onclick="deleteActivite('+index+')"><i class="la la-minus-circle"></i></button></div>';     
             ret += '</div>';
             return ret;
         }
        ...
        function getRowTableDiplome(index){
            ...
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiplome('+index+')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function getRowTableParcours(index){
            ...
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteParcours('+index+')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableAttrib(index){
            ...
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteAttrib('+index+')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableTache(index){
            ...
            ret += '<div class="col-md-8"><input class="form-control" placeholder="Tache" type="text" name="tache_journaliere[]"/></div>';     
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteTache('+index+')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTablePost(index){
            ...
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiv('+index+',\'post_row\')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableProduit(index){
            ...
            ret += '<div class="col-md-8"><input class="form-control" placeholder="Poste de travail" type="text" name="produit_periodique[]"/></div>';     
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiv('+index+',\'produit_row\')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableAcad(index){
            ...
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiv('+index+',\'formation_academique_row\')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableProf(index){
            ...
            ret += '<div class="col-md-8"><input class="form-control" placeholder="Formation Academique" type="text" name="formation_professionnelle[]"/></div>';     
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiv('+index+',\'formation_academique_row\')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableRequi(index){
            ...
            ret += '<div class="col-md-8"><input class="form-control" placeholder="Requi" type="text" name="savoir_requi[]"/></div>';     
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiv('+index+',\'tache_row\')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableFaire(index){
            ...
            ret += '<div class="col-md-8"><input class="form-control" placeholder="Faire" type="text" name="savoir_faire[]"/></div>';     
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiv('+index+',\'faire_row\')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function  getRowTableEtre(index){
            ...
            ret += '<div class="col-md-8"><input class="form-control" placeholder="Etre" type="text" name="savoir_etre[]"/></div>';     
            ret += '<div class="col-md-1"><button class="form-control btn_close" type="button" onclick="deleteDiv('+index+',\'etre_row\')"><i class="la la-minus-circle"></i></button></div>';     
            ret += '</div>';
            return ret;
        }
        ...
        function changeSoa(){
            ...
            $.ajax({
                     ...
                     success: function(data, textStatus, jqXHR) {
                           ...
                           //select_option += '<option value="9999">------</option>';
                           obj.forEach(function(module) {
                               select_option += '<div class="row"><input type="checkbox" name="soa[]" value="'+module['id']+'"/>'+module['libele']+'</div>';
                           });
                           //select_option += '<option value="0">AUTRES</option>';
        ...
        function changeDistrict(){
            ...
            $.ajax({
                 ...
                 type: 'get',
                 success: function(data, textStatus, jqXHR) {
                       var objArray = jQuery.parseJSON(data);
                       $('#departement').html('');
                       var select_option1 = "";
...
function changeDepartement(){
    ...
    $.ajax({
             url: base_url() + "json/direction/"+valeur+"/"+district,
             type: 'get',
             success: function(data, textStatus, jqXHR) {
                   var obj = jQuery.parseJSON(data);
                   $('#direction').html('');
 ...
 function changeDirection(){
    ...
    $.ajax({
             url: base_url() + "json/service/"+valeur+"/"+district,
             type: 'get',
             success: function(data, textStatus, jqXHR) {
                   var obj = jQuery.parseJSON(data);
                   $('#service').html('');
