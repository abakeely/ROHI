...
<div id="container">
	<div id="breadcrumb"><a href="{$zBasePath}">Accueil</a> <span>&gt;</span> <a href="{$zBasePath}">Formation</a> <span>&gt;</span> <a href="{$zBasePath}">Offres</a><span>&gt;</span>Foramtions payantes</div>

    <section id="content">
        {include_php file=$zLeft}	
		<div id="innerContent">
		<div id="ContentBloc">
		<h2>Liste des formations payantes {if $oData.iSessionCompte == COMPTE_AUTORITE || $oData.iSessionCompte == COMPTE_ADMIN}
		&agrave; finaliser
...
{assign var=i value=$i+1}
	<td class="zoom">
		<div class = "classClick">
		 <br>
		  <a href="#liste{$i}">
			<img src="{$zBasePathRacine}/backoffice/assets/img/img_sfao/partenaire/formation_payante/{$oPartenaire.partenaire_photo}" >
			<br><br>
		  </a>
	    </div>
              ...
              <tbody>
				{foreach from=$oData.contenuformation  item=oContenu}
    				...
    				<tr>
                      ...
                      <td>
						<a target="blanck" class="la la-download" style="font-size: 2.5em;" style="font-size: 2.5em;" title="Télécharger" href="{$zBasePathRacine}/backoffice/assets/pdf_sfao/concours/{$oContenu.contenuformation_fichier_pdf}"></a>	</td>
					</tr>
					{/if}
				{/foreach}
              </tbody>
