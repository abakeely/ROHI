        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse in">
				...
				<li {if $iModuleActif == -1} class="active" {/if}>
                  ...
                  <i class="la la-graduation-cap fa-lg"></i> Formation
                  </a>
                </li>
				<li {if $iModuleActif == -2} class="active" {/if}>
                  <a href="{$zBasePath}documentation/sad">
                  <i class="la la-archive fa-lg"></i> Archives et Documentation
                  </a>
                </li>
				{php}
                ...
                <ul class="sub-menu collapse {if $iModuleActif|in_array:$toComm}in{/if}" id="new">
					<li {if $iModuleActif == -4} class="active" {/if}><a href="{$zBasePath}accueil/liste/communique/bo"><i class="la la-file-text"></i>Communiqu&eacute;</a></li>
