...
<div id="container">
	<div id="breadcrumb"><a href="{$zBasePath}">Accueil</a> <span>&gt;</span> <a href="#">Formation</a> <span>&gt;</span> <a href="{$zBasePath}">Offres</a><span>&gt;</span> Offres locales</div>
	{include_php file=$zHeader}
    <section id="content">
        {include_php file=$zLeft}	
		<div id="innerContent">
		<div id="ContentBloc">
		<h2>Liste des Offres locales {if $oData.iSessionCompte == COMPTE_AUTORITE || $oData.iSessionCompte == COMPTE_ADMIN}
		&agrave; finaliser
              ...
              <tbody>
				{foreach from=$oData.contenuformation  item=oContenu}
    				...
    				<tr>
                      ...
                      <td>
						<a target="blanck" class="la la-download" style="font-size: 2.5em;" style="font-size: 2.5em;" title="Télécharger" href="{$zBasePath}assets/pdf_sfao/offre/{$oContenu.contenuformation_fichier_pdf}"></a>	</td>
					</tr>
					{/if}
				{/foreach}
              </tbody>
