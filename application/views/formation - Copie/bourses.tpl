...
<div id="container">
	<div id="breadcrumb"><a href="{$zBasePath}">Accueil</a> <span>&gt;</span> <a href="{$zBasePath}">Formation</a> <span>&gt;</span> <a href="{$zBasePath}">Offres</a><span>&gt;</span> Bourses</div>
    <section id="content">
        {include_php file=$zLeft}	
		<div id="innerContent">
		<div id="ContentBloc">
		<h2>Liste des Bourses {if $oData.iSessionCompte == COMPTE_AUTORITE || $oData.iSessionCompte == COMPTE_ADMIN}
		&agrave; finaliser
				...
				{foreach from=$oData.contenuformation  item=oContenu}
    				...
    				<tr>
                      <td>{$oContenu.contenuformation_titre}</td>
						<td>
						<a target="blanck" class="la la-download" style="font-size: 2.5em;" style="font-size: 2.5em;" title="Télécharger" href="{$zBasePathRacine}/backoffice/assets/pdf_sfao/bourse/{$oContenu.contenuformation_fichier_pdf}"></a>	
						</td>
					</tr>
					{/if}
				{/foreach}
