...
<div id="container">
	<div id="breadcrumb"><a href="{$zBasePath}">Accueil</a> <span>&gt;</span> <a href="{$zBasePath}">Formation</a><span>&gt;</span><a href="{$zBasePath}formation/nomencl/sfao/nomenclature-poste">Référentieles de formation</a><span>&gt;</span>Cartographie des effectifs et des emplois</a></div>
    <section id="content">
        {include_php file=$zLeft}	
		<div id="innerContent">
		<div id="ContentBloc">
		<h2>Cartographie des effectifs et des emplois{if $oData.iSessionCompte == COMPTE_AUTORITE || $oData.iSessionCompte == COMPTE_ADMIN}
		&agrave; finaliser
