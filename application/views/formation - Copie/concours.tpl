...
<div id="container">
	<div id="breadcrumb"><a href="{$zBasePath}">Accueil</a> <span>&gt;</span> <a href="{$zBasePath}">Formation</a> <span>&gt;</span> <a href="{$zBasePath}">Offres</a><span>&gt;</span> Concours</div>
    <section id="content">
        {include_php file=$zLeft}	
		<div id="innerContent">
		<div id="ContentBloc">
		<h2>Liste des Concours {if $oData.iSessionCompte == COMPTE_AUTORITE || $oData.iSessionCompte == COMPTE_ADMIN}
		&agrave; finaliser
...
{assign var=i value=$i+1}
	<td class="zoom">
		<div class = "classClick">
		 <br>
		  <a href="#liste{$i}">
			<img src="../../../../backoffice/assets/img/img_sfao/partenaire/{$oPartenaire.partenaire_photo}" >
			<br><br>
		  </a>
	    </div>
            ...
            <table align="center" class="table table-bordered table-hover dataTable no-footer">
              <thead>
                <tr role="row">
                  ...
                  <th class="th_livre" style="text-align:center">Action</th>
                </tr>
              </thead>
              <tbody>
				{foreach from=$oData.contenuformation  item=oContenu}
    				...
    				<tr>
                      ...
                      <td>
						<a target="blanck" class="la la-download" style="font-size: 2.5em;" style="font-size: 2.5em;" title="Télécharger" href="{$zBasePath}assets/pdf_sfao/concours/{$oContenu.contenuformation_fichier_pdf}"></a>	</td>
					</tr>
					{/if}
				{/foreach}
              </tbody>
