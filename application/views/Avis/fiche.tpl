					...
					<div class="row align-items-center">
						<div class="col-12">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item">Fiche > Titre de paiement</li>
							</ul>
						</div>
					</div>
				</div>
													...
													<div id="searchAcc">
														<div class="card punch-status">
															...
															<form action="{$zBasePath}titre/fiche/titre-de-paiement" method="POST" name="formulaireTransaction" id="formulaireTransaction" style="display:block!important" enctype="multipart/form-data">
																<fieldset>
																	{if ($oData.oUser.id == "11") OR ($oData.oUser.id == "11470") OR ($oData.oUser.id == "3221") OR ($oData.oUser.id == "4430")}
																	<div class="row1">
																		<div class="cell">
																			<div class="field">
																				<label>Matricule</label>
																				<input type="text" class="form-control" style="width:189px!important" name="iSendBas" id="iSendBas" value="{$oData.iMatricule}" placeholder="matricule">
																			</div>
																		</div>
																	</div>
																	{/if}
																	...
																	<div class="row1">
																		<div class="cell">
																			<div class="field" style="text-align:center">
																				 <input class="form-control" type="button" class="button" onClick="fichePaiement();" name="" id="" value="Rechercher">
																			</div>
																		</div>
																	</div>
																	<div class="row1">
