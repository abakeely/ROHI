...
<div id="container">
 <section id="content">
		...
		<!--h2>Fiche > Titre de paiement</h2-->
		<div id="breadcrumb">Fil d'ariane&nbsp;&nbsp;:&nbsp;&nbsp;<a href="{$zBasePath}">Accueil</a> <span>&gt;</span> <a href="{$zBasePath}">RH</a> <span>&gt;</span> <a href="{$zBasePath}">titre de paiement</a> <span>&gt;</span> Fiche </div>
			<div class="SSttlPage">
                    <div id="searchAcc">
                        <div class="card punch-status">
                            ...
                            <form action="{$zBasePath}titre/fiche/titre-de-paiement" method="POST" name="formulaireTransaction" id="formulaireTransaction" style="display:block!important" enctype="multipart/form-data">
                                <fieldset>
									{if $oData.oUser.id == 9961 AND $oData.zBasePath == 'http://localhost:8088/ROHI/'}
									<div class="row1">
										<div class="cell">
											<div class="field">
