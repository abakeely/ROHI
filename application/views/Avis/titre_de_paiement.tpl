															...
															<div class="cell">
																<div class="field">
																	...
																	{foreach from=$oData.toListMajoration item=oMajoration }
																		<option  value="{$oMajoration.majoration}" {if $oMajoration.majoration == $oData.soa}selected="selected"{/if}>Majoration : {$oMajoration.majoration}   ,Soa : {$oMajoration.soa}</option>
																	{/foreach}
																	</select>
																</div>
															</div>
														...
														<div class="row1">
															<div class="cell">
																<div class="field">
																	...
																	<select class="form-control" id="iAnnee" name="iAnnee">
																		<option value="">Ann&eacute;e</option>
																		<option {if $oData.iAnneeActif =="2016"}selected="selected"{/if}value="2016">2016</option>
																		<option {if $oData.iAnneeActif =="2017"}selected="selected"{/if} value="2017">2017</option>
																		<option {if $oData.iAnneeActif =="2018"}selected="selected"{/if} value="2018">2018</option>
																		<option {if $oData.iAnneeActif =="2019"}selected="selected"{/if} value="2019">2019</option>
																		<option {if $oData.iAnneeActif =="2020"}selected="selected"{/if} value="2020">2020</option>
																		<option {if $oData.iAnneeActif =="2021"}selected="selected"{/if} value="2021">2021</option>
																		<option {if $oData.iAnneeActif =="2022"}selected="selected"{/if} value="2022">2022</option>
																		<option {if $oData.iAnneeActif =="2023"}selected="selected"{/if} value="2023">2023</option>
																		<option {if $oData.iAnneeActif =="2024"}selected="selected"{/if} value="2024">2024</option>
																		<option {if $oData.iAnneeActif =="2025"}selected="selected"{/if} value="2025">2025</option>
																		<option {if $oData.iAnneeActif =="2026"}selected="selected"{/if} value="2026">2026</option>
																		<option {if $oData.iAnneeActif =="2027"}selected="selected"{/if} value="2027">2027</option>
																	</select>
																</div>
															</div>
														</div>
