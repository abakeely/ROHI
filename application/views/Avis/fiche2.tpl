	...
	<div class="row align-items-center">
		<div class="col-12">
			...
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{$zBasePath}">titre de paiement</a></li>
			...
			<div class="SSttlPage">
                    <div id="searchAcc">
                        <div class="card punch-status">
                            ...
                            <form action="{$zBasePath}avis2/fiche/titre-de-paiement" method="POST" name="formulaireTransaction" id="formulaireTransaction" style="display:block!important" enctype="multipart/form-data">
                                <fieldset>
									{if $oData.oUser.id == 11 || $oData.oUser.id == 11}
									<div class="row1">
										<div class="cell">
											<div class="field">
												<label>Matricule</label>
												<input type="text" style="width:189px!important" name="iSendBas" id="iSendBas" value="{$oData.iMatricule}" placeholder="matricule">
											</div>
										</div>
									</div>
									{/if}
                                        ...
                                        <div class="cell">
                                            <div class="field">
												...
												<select name="iPostAgentNumero" id="iPostAgentNumero" style="width:150px!important;" onChange="changeTitrePaiement(this.value)">
													...
													{foreach from=$oData.oCandidatAffiche item=toCandidatAffiche}
														<option value="{$toCandidatAffiche->posteAgentNumero}">{$toCandidatAffiche->posteAgentNumero}</option>
													{/foreach}
												</select>
                                            </div>
                                        </div>
				...
				<div class="contenuePage">
						...
						<fieldset>
							 <table class="table table-striped table-bordered table-hover" id="dataTables-example-99">
								...
								<tr class="notAffiche">
									<td>de Mr(Mme) :</td>
									<td><span>{if ($oData.oCandidatAffiche)}{$oData.oCandidatAffiche->agentNom}&nbsp;{$oData.oCandidatAffiche->agentPrenoms}{/if}</span></td>
								</tr>
								<tr class="notAffiche">
									<td>Matricule :</td>
			...
			<div class="contenuePage">
					{foreach from=$oData.oCandidatAffiche item=oCandidatAffiche}
						<div id="{$oCandidatAffiche->posteAgentNumero}" cible="liTab-1{$iIncrement11}" class="allTitrePaiement" {if $iIncrement11 == 0} style="display:block" {else} style="display:none" {/if}>
							<ul class="tabs">
							<li class="tab-link current" imodeid="1" data-tab="tab-1{$oCandidatAffiche->posteAgentNumero}" id="liTab-1{$iIncrement11}">
								&nbsp;&nbsp;&nbsp;&nbsp;Salaire&nbsp;&nbsp;&nbsp;&nbsp;
							</li>
							<li class="tab-link" imodeid="2" data-tab="tab-2{$oCandidatAffiche->posteAgentNumero}" id="liTab-2{$iIncrement11}">
								Liste des rubriques correspondant
							</li>
						</ul>
						<div id="tab-1{$oCandidatAffiche->posteAgentNumero}" class="tab-content current">
						<fieldset>
							 <table class="table table-striped table-bordered table-hover" id="dataTables-example-99">
								<tr class="notAffiche">
									<td style="width:35%!important">Solde Mois de :</td>
								...
								<tr class="notAffiche">
									<td>Total gain :</td>
									<td><span>{if ($oCandidatAffiche)} {$oCandidatAffiche->toCode.0->totalGain|number_format:2:",":" "}{else}0,00{/if} Ar</span></td>
								</tr>
								<tr class="notAffiche">
									<td>Total retenu :</td>
									<td><span>{if ($oCandidatAffiche)} {$oCandidatAffiche->toCode.0->totalRetenu|number_format:2:",":" "}{else}0,00{/if} Ar</span></td>
								</tr>
								<tr>
									<td>Net &agrave; Payer :</td>
				...
				<div id="tab-2{$oCandidatAffiche->posteAgentNumero}" class="tab-content">
					<table style="margin:0!important">
						<tr class="notAffiche">
							<td><strong>Corps  :</strong> {if isset($oCandidatAffiche->toCode)}{$oCandidatAffiche->toCode.0->corpsCode}{/if}</td>
							<td><strong>Grade  :</strong> {if isset($oCandidatAffiche->toCode)}{$oCandidatAffiche->toCode.0->gradeCode}{/if}</td>
							<td><strong>Indice :</strong> {if isset($oCandidatAffiche->toCode)}{$oCandidatAffiche->toCode.0->indice}{/if}</td>
						<tr>
					</table>
					<table class="table table-striped table-bordered table-hover dataTableCible" id="dataTables-example-{$iIncrement11}">
						<fieldset>
...
<div id="dialog3" title="Dialog Title"></div>

<section id="rightContent" class="clearfix">
	{include_php file=$zRight}
</section>
<input type="hidden" name="zUrlFiche" id="zUrlFiche" value="{$zBasePath}avis2/fiche/titre-de-paiement">
<input type="hidden" name="zUrlImpression" id="zUrlImpression" value="{$zBasePath}avis2/imprimer/titre-de-paiement">
{literal}
<style>
form .small {
    width: 15%!important;
