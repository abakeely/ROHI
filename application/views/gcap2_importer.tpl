...
<div class="page-header">
	<div class="row align-items-center">
		<div class="col-12">
			<h3 class="page-title">Importation d'un excel</h3>
			<ul class="breadcrumb">
				<li class="breadcrumb-item"><a href="{$zBasePath}">Accueil</a></li>
				<li class="breadcrumb-item"><a href="#">RH</a></li>
				<li class="breadcrumb-item"><a href="#">GCAP</a></li>
    ...
    <section id="content">
		...
		<!--*Debut Contenue*-->
            ...
            <div id="tab-1" class="tab-content current">
                <div class="row1">
                    <form action="{$zBasePath}gcap2/importation" method="POST"  name="formulaireExcel" id="formulaireExcel" style="display:block!important" enctype="multipart/form-data">
                        <input type="hidden" name="iFlag" id="iFlag" value="1" />
						<fieldset>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="field">
                                        <label>Premiere Ligne</label>
                                        <input type="text" name="PremiereLigne" id="PremiereLigne" class="form-control" value="7" placeholder="Nom"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="field">
                                        ...
                                        <div class="field">
                                            <td><input type="file" name="file_excel" id="file_excel" style="display:none" class="form-control" class="inputfile inputfile-1 inputDotation" data-multiple-caption="files selected" accept=".xlsx, .xls"/>
                            ...
                            <div style="margin:50px"class="clearfix">
                                <div class="field col-xs-12 col-sm-12 text-center">
                                    <input type="button"  name="" id="Tester" onclick="saveDotation(1)" value="Tester" >
									<input type="button"  name="" id="Importer" onclick="saveDotation(2)" value="Importer">
                                </div>
                            </div>
                        </fieldset>
                    </form>
...
function saveDotation(_iFlag)
{
	...
	if($(".inputDotation").val()==''){
		alert("Veuillez entrer le fichier excel!");
	} else {
		$("#iFlag").val(_iFlag);
		switch (_iFlag)
		{
			case 1 :
				$('#formulaireExcel').attr("target","_blank");
				break;

			case 2 :
				$('#formulaireExcel').removeAttr("target");
				break;
		
		}
		$('#formulaireExcel').submit();
	}
