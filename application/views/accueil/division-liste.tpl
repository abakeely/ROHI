	...
	{include_php file=$zHeader}
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col-12">
							<h3 class="page-title">Liste des divisions rattachées</h3>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="{$zBasePath}">Accueil</a></li>
								<li class="breadcrumb-item">Liste des divisions rattachées</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="field">
					<div class="col-3">
						<form action="{$zBasePath}accueil/editDivision/{$oData.zHashModule}/{$oData.zHashUrl}" method="POST" name="formulaireAjout" id="formulaireAjout" enctype="multipart/form-data">
							...
							<div class="card-body">
									...
									<tbody>
										...
										<tr {if $iIncrement%2 == 0} class="even" {/if}>
											<td>{$oListe.libele}</td>
											<td>{$oListe.sigle_module}</td>
											<td>
											{if $oListe.departement_id != ""}
											DEPARTEMENT
											{elseif $oListe.direction_id != ""}
											DIRECTION
											{else}
											SERVICE
											{/if}
											...
											<td class="center">
												<a href="{$zBasePath}accueil/editDivision/{$oData.zHashModule}/{$oData.zHashUrl}/{$oListe.fichePoste_id}" title="" class="action"><i style="color:#12105A;font-size:23px;" title="Modifier" alt="Modifier" class="la la-edit"></i></a>
