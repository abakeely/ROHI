	...
	{include_php file=$zHeader}
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col-12">
							<h3 class="page-title">Division Edit</h3>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="{$zBasePath}">Accueil</a></li>
								<li class="breadcrumb-item">Division Edit</li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="card-body">
									...
									<div class="clearfix">
										<div class="cell small">
											<div class="field">
												<label>Date *:</label>
												<input type="text" name="zDate" id="zDate" data-dd-opt-format="dd/mm/y" data-dd-opt-default-date="{$oData.toRevueCommunique.revueCommunique_date|date_format2}" placeholder="s&eacute;l&eacute;ctionner la date" value="{$oData.toRevueCommunique.revueCommunique_date|date_format:"%d/%m/%Y"}" class="form-control withDatePicker obligatoire">
									...
									<div class="clearfix">
										<div class="cell">
											<label>Image : </label>
											<div class="field">
												<input type="file" id="zImage" name="zImage" class="jfilestyle" class="form-control" data-placeholder="Image" data-buttonText="<span class='glyphicon glyphicon-picture'></span>">
									...
									<div id="iFichier"  {if $oData.toRevueCommunique.revueCommunique_type == 1} style="display:block;" {else} style="display:none;"{/if} class="clearfix">
										<div class="cell">
											<label>Fichier * : </label>
											<div class="field">
												<input type="file" id="zFile" name="zFile" class="jfilestyle1" class="form-control obligatoire">{$oData.toRevueCommunique.revueCommunique_fichier}
									...
									<div class="clearfix">
										<div class="cell">
											...
											<div class="field">
												<input type="text" id="zJournaliste" name="zJournaliste" value="{$oData.toRevueCommunique.revueCommunique_journaliste}" class="obligatoire">
												<p class="form-control message">Veuillez entrer le nom du journaliste</p>
											</div>
										</div>
									</div>
									<div class="clearfix">
