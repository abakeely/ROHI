			...
			{include_php file=$zHeader}
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col-12">
								<!--h3 class="page-title">Offres payantes</h3-->
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item">Formations payantes</li>
								</ul>
							</div>
						</div>
					</div>
																							...
																							{foreach from=$oData.contenuformation  item=oContenu}	
																								...
																								<tr>
																									...
																									<td class="zoom1" align="center">
																										<a title="Télécharger" href="{$zBasePathBo}{$oContenu.contenuformation_fichier_pdf}" target="_blank" title="Télécharger le pdf" >
