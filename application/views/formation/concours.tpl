			...
			{include_php file=$zHeader}
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col-12">
								<!--h3 class="page-title">Concours</h3-->
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item">Concours</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="card-body">
								<div class="contenuePage" style="margin-bottom: 50px !important;">
									<div align="right">
																							...
																							{foreach from=$oData.contenuformation  item=oContenu}	
																								...
																								<tr>
																									...
																									<td class="zoom1" align="center" >
																										<a title="Télécharger" href="{$zBasePathBo}{$oContenu.contenuformation_fichier_pdf}" target="_blank" title="Télécharger le fichier">
																											<img  src="{$zBasePath}assets/img/img_sfao/down.png"   style="width:70px">
																										</a>
