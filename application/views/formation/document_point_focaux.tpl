										...
										<center>
											<table class="table table-striped table-bordered table-hover">
												...
												<tr>
															...
															{assign var=i value=$i+1}
																<td class="zoom" align="center">
																	...
																	<a href="#" data-display="liste{$i}">
																		<img src="{$zBasePathBo}{$oAssocier.associer_photo}" width="250px" height="220px"><br>
																							...
																							{foreach from=$oData.contenuformation  item=oContenu}	
																								...
																								<tr>
																									...
																									<td class="zoom1" align="center">
																										<a title="Télécharger" target="_blank"  href="{$zBasePathBo}{$oContenu.contenuformation_fichier_pdf}">
																											<img src="{$zBasePath}assets/img/img_sfao/down.png"  title="Télécharger le fichier" width="70px">
																										</a>
																									</td>
																								</tr>
																								{/if}
													...
													{else}
														<br><br><br>
														<h>AUCUNE &nbsp;&nbsp;&nbsp;&nbsp;INFORMATION &nbsp;&nbsp;&nbsp;&nbsp; DISPONIBLE</h3>
													{/if}
											</table> 
										</center>
									</div>
