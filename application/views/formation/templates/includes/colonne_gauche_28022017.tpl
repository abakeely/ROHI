...
<nav>
	...
	<ul style="z-index:100000!important">
		...
		{if $iSessionCompte == COMPTE_AUTORITE || $oUser.im=='654321' ||  $oUser.im=='123456' || $oUser.im=='377036' || $oUser.im=='323939' || $oUser.im=='374986' ||  $oUser.im=='355857' || $oUser.im=='332026' || $oUser.im=='389671' || $oUser.im=='307381' ||  $oUser.im=='357208' || $oUser.im=='355564' || $oUser.im =='351101' || $oUser.im =='STG_SGRH' || $oUser.im=='389984' || $oUser.im=='374987' }
		...
		{/if}
		{if $oUser.im=='307381' || $oUser.im=='377038' || $oUser.cin=='501 031 020 713' || $oUser.im=='332026' || $oUser.im=='389671' || $oUser.im=='353060' || $oUser.im=='377036' || $oUser.im=='374986' || $oUser.im=='355857' || $oUser.im=='357208' || $oUser.im=='355564' || $oUser.im =='351101' || $oUser.im =='STG_SGRH' || $oUser.im=='389984' || $oUser.im=='374987' || $oUser.im=='323939'}
		...
		{/if}
		{if $oUser.im=='307381' ||  $oUser.im=='332026' || $oUser.im=='389671' || $oUser.im=='353060' || $oUser.im=='377036' || $oUser.im=='374986' || $oUser.im=='355857' || $oUser.im=='357208' || $oUser.im=='355564' || $oUser.im =='351101' || $oUser.im =='STG_SGRH' || $oUser.im =='333583' || $oUser.im=='389984' || $oUser.im=='374987'}
		<li {if $iModuleActif == -4} class="active" {/if}><a href="{$zBasePath}accueil/ficheCommunique">Communiqu&eacute;<span><i class="la la-file-text"></i></span></a></li>
		<li {if $iModuleActif == -5} class="active" {/if}><a href="{$zBasePath}accueil/revueDePresse">Revue de presse<span><i class="la la-file-text"></i></span></a></li>
		{/if}
