			...
			{include_php file=$zHeader}
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col-12">
								<h3 class="page-title">
									Cartographie des effectifs et des emplois{if $oData.iSessionCompte == COMPTE_AUTORITE || $oData.iSessionCompte == COMPTE_ADMIN}
									&agrave; finaliser
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item">Cartographie des effectifs et des emplois<</li>
								</ul>
							</div>
						</div>
					</div>
