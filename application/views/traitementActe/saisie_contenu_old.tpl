...
<div id="container">
	<section id="content">
        ...
        <div id="innerContent">
            <div id="saisieActe">
                <h2>Saisie du projet d'acte</h2>
				<div id="breadcrumb"><a href="{$zBasePath}">Accueil</a> <span>&gt;</span>Saisie de contenu</div>
				...
				<div class="panel-body">
					<h3>RUBRIQUES COMPLEMENTAIRES</h3>
				</div>
				<div class="row">
					<div class="row1">
						<div class="libele_form">
 ...
 <script>
	...
	function addRub(){
		...
		var ligne				= "<tr>";
		    ...
		    ligne				= ligne + "</tr>";
		$("#data_table_rubrique").append(ligne);

		var nouveau_rubriques	= rubrique_code +","+date_debut_rubrique+","+date_fin_rubrique;
