...
<div id="container">
    <section id="content">
		...
		<div id="innerContent">
		<div id="ContentBloc">
		<h2>Attribution du visa du projet d'acte</h2>
            ...
            <div id="saisieActe">
				...
				<div class="row">
					...
					<div class="row1">
						...
						<input type="text" class="form-control obligatoire" placeholder="VISA Cde"  name="numero_visa_cf" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="numero_visa_cf" value=""> 
					</div>
					<div class="row1">
						<div class="libele_form">
							<label class="control-label label_rohi " data-original-title="" title=""><b>Date visa Cde(*) </b></label>
						</div>
						<input type="text" class="form-control datepicker obligatoire" placeholder="Date visa Cde"  name="date_visa_cf" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="date_visa_cf" value="">
					</div>
					<div class="row1">
						<div class="libele_form">
							<label class="control-label label_rohi " data-original-title="" title=""><b>Signataire visa Cde(*) </b></label>
						</div>
						<input type="text" class="form-control obligatoire" placeholder="Signataire visa Cde"  name="signataire_visa_cf" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="signataire_visa_cf" value="" >
					</div>
				</div>
				<div class="panel-body">
					<h3>Rattachement</h3>
