...
<div class="panel-wrap open">
	...
	<div class="col-md-2">
		...
		<input type="text" class="form-control obligatoire" placeholder="Numero du ticket"  name="ticket_code" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="ticket_code" value="">
	</div>
	<div class="col-md-3">
		<div class="libele_form">
...
<div class="panel-wrap">
	<div class="row">
		...
		<div class="row1">
			...
			<input type="text" class="form-control" placeholder="Structure(Uadm Code)"  name="nouveau_uadm_code" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="nouveau_uadm_code" value="" readonly="true" class="readonly">
		</div>
		<div class="col-sm-1">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Cadre </b></label>
			</div>
			<input type="text" class="form-control" placeholder="Cadre"  name="nouveau_cadre" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="nouveau_cadre" value="" readonly="true" class="readonly">
		</div>
		<div class="row1">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Code corps(*) </b></label>
			...
			<input type="text" class="form-control" placeholder="Corps"  name="nouveau_corps_code" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="nouveau_corps_code" value="" readonly="true" class="readonly">
		</div>
		<div class="col-sm-3">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Code grade(*) </b></label>
			...
			<input type="text" class="form-control" placeholder="Grade"  name="nouveau_grade_code" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="nouveau_grade_code" value="" readonly="true" class="readonly">
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		...
		<div class="row1">
			...
			<input type="text" class="form-control datepicker" placeholder="Date d'effet"  name="nouveau_date_effet" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="nouveau_date_effet" value="" >
		</div>
	</div>
</div>
<div class="panel_body">
...
<div class="panel-wrap">
	<div class="row">
		<div class="row1">
			...
			<input type="text" class="form-control obligatoire" placeholder="VISA FIN"  name="numero_visa_fin" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="numero_visa_fin" value=""  class="">
		</div>
		<div class="row1">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Date visa fin(*) </b></label>
			</div>
			<input type="text" class="form-control datepicker obligatoire" placeholder="Date visa fin"  name="date_visa_fin" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="date_visa_fin" value=""  class="">
		</div>
		<div class="row1">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Signataire visa fin(*) </b></label>
			</div>
			<input type="text" class="form-control obligatoire" placeholder="Signataire visa fin"  name="signataire_visa_fin" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="signataire_visa_fin" value="" class="">
		</div>
		<div class="row1">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Visa Cde(*) </b></label>
			</div>
			<input type="text" class="form-control" placeholder="VISA Cde"  name="" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="" value="" readonly="true" class="readonly"> 
		</div>
		<div class="row1">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Date visa Cde(*) </b></label>
			</div>
			<input type="text" class="form-control" placeholder="Date visa Cde"  name="" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="" value="" readonly="true" class="readonly">
		</div>
		<div class="row1">
			<div class="libele_form">
				<label class="control-label label_rohi " data-original-title="" title=""><b>Signataire visa Cde(*) </b></label>
			</div>
			<input type="text" class="form-control" placeholder="Signataire visa Cde"  name="" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="" value="" readonly="true" class="readonly">
		</div>
	</div>
</div>
