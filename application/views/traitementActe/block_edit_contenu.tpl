...
<div class="row">
	...
	<div class="col-sm-1">
		...
		<input type="text" class="form-control" placeholder="Cadre"  name="cadre" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="cadre" value="A" readonly="true" class="readonly">
	</div>
	<div class="row1">
		<div class="libele_form">
...
<div class="row">
	<div class="row1">
		...
		<input type="text" class="form-control" placeholder="VISA FIN"  name="" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="" value="" readonly="true" class="readonly">
	</div>
	<div class="row1">
		<div class="libele_form">
			<label class="control-label label_rohi " data-original-title="" title=""><b>Date visa fin(*) </b></label>
		</div>
		<input type="text" class="form-control" placeholder="Date visa fin"  name="" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="" value="" readonly="true" class="readonly">
	</div>
	<div class="row1">
		<div class="libele_form">
			<label class="control-label label_rohi " data-original-title="" title=""><b>Signataire visa fin(*) </b></label>
		</div>
		<input type="text" class="form-control" placeholder="Signataire visa fin"  name="" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="" value="" readonly="true" class="readonly">
	</div>
	<div class="row1">
		<div class="libele_form">
...
<div class="row" id="rattachement_structure">
	<input type="hidden"  value="" id="departement_edit"/>
	<input type="hidden"  value="" id="direction_edit"/>
	<input type="hidden"  value="" id="service_edit"/>
	<div class="col-sm-3">
		...
		<select class="form-control" placeholder="Departement"  onChange="getLocaliteCv('{$zBasePath}',1,this.value);" name="departement" data-toggle="tooltip" data-original-title= "Safidio ny Departemanta na sampan-draharaha misy anao" id="departement">
			...
			{foreach from=$oData.list_departement item=oDepartement}
				...
				<option  value={$oDepartement.id}>{$oDepartement.libele}</option>
				{/if}
			{/foreach}
		</select>
	</div>
	<div class="col-sm-3" id="iLocalite_1">{$oData.zSelectDirection}</div>
	<div class="col-sm-3" id="iLocalite_2">{$oData.zSelectService}</div>
	<div class="col-sm-3" id="iLocalite_3">{$oData.zSelectSouService}</div>
	<div class="col-sm-3" id="iLocalite_4">{$oData.zSelectDivision}</div>
</div>
<div class="panel-body" >
...
<div class="row">
	...
	<div class="row1">
		...
		<input type="text" class="form-control datepicker" placeholder="Date d'effet solde"  name="" data-placement="top" data-toggle="tooltip" data-original-title="Numero"  id="" value="">
	</div>
	<div class="row1">
		<div class="libele_form">
			<label class="control-label label_rohi " data-original-title="" title=""><b>Anciente conserve(*) </b></label>
