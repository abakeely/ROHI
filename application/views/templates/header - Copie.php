...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/gcap/css/app/app_main.css?2017v1">
	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/BrightSide.css<?php echo $version;?>">

	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/style.css<?php echo $version;?>2017">
    ...
    <header id="mainHeader">
        ...
        <div id="mainHeaderBottom">
			...
			<form name="setCompte" id="setCompte" action="<?php echo base_url();?>gcap/setSessionCompte" method="POST">
				...
				<fieldset>
						<div class="field">
							<select name="iCompteId" id="iCompteId" style="width:200px;font-size:0.8em;" onChange="document.setCompte.submit();">
				...
				<?php if (isset($candidat) && ($candidat->candidat_batimentId>0) || isset($candidat2) && ($candidat2->candidat_batimentId>0)) { ?>
				<ul id="ticker01" style="display:none;">
					<li><span>Le système de <a href="<?php echo base_url();?>gcap/module/pointage-electronique">pointage électronique</a>intègrera <?php echo $batimentLibelle;?> prochainement. Désormais, vous allez pouvoir consulter sur</span></li>
					<li><span>ROHI vos heures d'arrivée et  de sortie dans l'onglet <a href="<?php echo base_url();?>gcap/module/pointage-electronique">pointage électronique</a> et ainsi mieux gérer votre timing.</span></li>
				</ul>
				<?php } ?>
        </div>
            ...
            <nav>
                <ul style="<?php echo (isset($menu_lucia))?" padding-top:1px;":"";?>">
				   <?php if(!isset($iModuleActif) || $iModuleActif!=7){ ?>
					...
					href="<?php echo base_url();?>formation/info_utile"><img src="<?php echo base_url();?>assets/img/img_sfao/conpetence.jpg" border="0" height="25" width="35">
					</i></a></li>
					...
					<li <?php if($iMenuActif==9){ echo 'class="active"'; }?> >
					        ...
					        ?> href="#" title=""></i>OFFRES</a>
                        <ul   style="width:300px;">
							<li><a class="color2" href="<?php echo base_url();?>formation/offre_local"></i>OFFRES LOCALES</a></li>
							<li><a class="color2" href="<?php echo base_url();?>formation/bourse"></i>BOURSES</a></li>
							<li><a class="color2" href="<?php echo base_url();?>formation/concours"></i>CONCOURS</a></li>
							<li><a class="color2" href="<?php echo base_url();?>formation/formation_payante"></i>FORMATIONS PAYANTES</a></li>
						</ul>	
                    </li>
					...
					<li <?php if($iMenuActif==11){ echo 'class="active"'; }?> >
					        <a <?php if(isset($menu_lucia)&&$menu_lucia==1){ echo 'class="menu_lucia_active"';  }else { echo 'class="menu_lucia_nonactive"';}
					        ?> href="#" title=""></i>LIENSUTILES</a>
                        <ul   style="width:300px;">
							<li><a class="color2" href="<?php echo base_url();?>formation/texte_reference"></i>TEXTE DE REFERENCES</a></li>
							<li><a class="color2" href="<?php echo base_url();?>formation/document_pointfocaux"></i>DOCUMENTS POINTS FACAUX</a></li>
					...
					<li <?php if($iMenuActif==12){ echo 'class="active"'; }?> >
                        ...
                        <ul   style="width:300px;">
							<li><a class="color2" href="<?php echo base_url();?>formation/photo"></i>PHOTO</a></li>
							<li><a class="color2" href="<?php echo base_url();?>formation/trombinoscope"></i>TROMBINOSCOPE</a></li>
						</ul>	
                    </li>
					
					<li <?php if($iMenuActif==13){ echo 'class="active"'; }?> >
					<a <?php if(isset($menu_lucia)&&$menu_lucia==3){ echo 'class="menu_lucia_active"';} else { echo 'class="menu_lucia_nonactive"';} ?> 
					href="<?php echo base_url();?>formation/planning_formation">
					</i>AGENTS FORMES</a></li>
					...
					<li <?php if($iMenuActif==12){ echo 'class="active"';  }?>>
                        <a <?php if(isset($menu_lucia)&&$menu_lucia==1){ echo 'class="menu_lucia_active"';  }else { echo 'class="menu_lucia_nonactive"';}
						?> href="#" title=""></i>&nbsp;&nbsp;INFOS PRATIQUES</a>
                        <ul style="width:250px;">
							...
							<li><a class="color2" href="<?php echo base_url();?>documentation/plan_d_acces"></i>&nbsp;&nbsp;PLAN D&acute;ACC&Egrave;S</a></li>
					...
					href="<?php echo base_url();?>documentation/catalogue_livre">
					</i>&nbsp;CATALOGUES</a></li>
					
					<li <?php if($iMenuActif==14){ echo 'class="active"'; }?> >
					<a <?php if(isset($menu_lucia)&&$menu_lucia==3){ echo 'class="menu_lucia_active"';} else { echo 'class="menu_lucia_nonactive"';} ?> 
					href="<?php echo base_url();?>nouveaute/nouveaute_liste">
					</i><img class="img_cat" id="cat_formation" src="<?php echo base_url();?>assets/img/new_tourne.gif">NOUVEAUTES</a></li>
					...
					<li <?php if($iMenuActif==15){ echo 'class="active"'; }?>>
						...
						href="#" title=""></i>&nbsp;&nbsp;DOCUMENTS NUMERIS&Eacute;S</a>
                        <ul style="width:250px;">
							<li><a class="color2" href="<?php echo base_url();?>documentation/texte_reglementaire"></i>&nbsp;&nbsp;TEXTES REGLEMENTAITRES</a></li>
							<li><a class="color2" href="<?php echo base_url();?>documentation/autre_numerise"></i>&nbsp;&nbsp;Ouvrages Numeris&eacute;s<br></a></li>
						</ul>	
                    </li>
					...
					<li <?php if($iMenuActif==19){ echo 'class="active"'; }?>>
						...
						href="#" title=""></i>&nbsp;&nbsp;SERVICES PROPOS&Eacute;S</a>
                        <?php if($role=="biblio"){?>
                        <ul style="width:250px;">
							<li><a class="color2" href="<?php echo base_url();?>documentation/liste_pret"></i>LISTE EMPRUNT</a></li>
							<li><a class="color2" href="<?php echo base_url();?>documentation/liste_besoin"></i>&nbsp;&nbsp;LISTE BESOINS SPECIFIQUES</a></li>
							<!--<li><a class="color2" href="<?php echo base_url();?>documentation/list_user_sad"></i>&nbsp;&nbsp;LISTE UTILISATEURS CONNECTES</a></li>-->
						</ul>	
						 <?php }else{?>
						 <ul style="width:250px;">
							...
							<li ><a class="color2" title="Besoin en ouvrage" href="<?php echo base_url();?>documentation/besoin_livre"></i>&nbsp;&nbsp;BESOINS SPECIFIQUES</a></li>
							<li><a class="color2" title="Liste besoin en ouvrage" href="<?php echo base_url();?>documentation/liste_besoin"></i>&nbsp;&nbsp;LISTES BESOINS SPECIFIQUES</a></li>
						</ul>
						<?php }?>
                    </li>
					 <?php if($role=="biblio"){?>
					<li <?php if($iMenuActif==20){ echo 'class="active"'; }?>>
						...
						href="#" title=""></i>TABLEAU DE BORD</a>
                        <ul style="width:250px;">
							<li><a class="color2" href="<?php echo base_url();?>tableau_bord/consult_place"></i>CONSULTATION SUR PLACE</a></li>
							<li><a class="color2" href="<?php echo base_url();?>tableau_bord/list_lecture_sur_place"></i>LISTE CONSULTATION SUR PLACE</a></li>
							<li><a class="color2" href="<?php echo base_url();?>tableau_bord/connexion_internet"></i>CONNEXION Cybernet</a></li>
							<li><a class="color2" href="<?php echo base_url();?>tableau_bord/list_connexion_net"></i>LISTE CONNEXION Cybernet</a></li>
							<li><a class="color2" href="<?php echo base_url();?>documentation/list_user_sad"></i>LISTE UTILISATEURS CONNECTES</a></li>
							<li><a class="color2" href="<?php echo base_url();?>tableau_bord/bilan"></i>STATISTIQUE</a></li>
							<li><a class="color2" href="<?php echo base_url();?>documentation/accueil_sfao"></i>ACCUEIL SFAO</a></li>
						</ul>					
                    </li>
					<?php }?>					
					<li <?php if($iMenuActif==16){ echo 'class="active"'; }?>>
						...
						href="<?php echo base_url();?>documentation/planning_restitution" title=""></i>&nbsp;RESTITUTION</a>	
                    </li>
					<!-- Fin Docuementations -->
			      <?php } else{?>
