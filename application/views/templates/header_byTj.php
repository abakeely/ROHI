            ...
            <nav>
                <ul style="<?php echo (isset($menu_lucia))?" padding-top:1px;":"";?>">
				   <?php if(!isset($iModuleActif) || $iModuleActif!=7){ ?>
					...
					<a <?php if(isset($menu_lucia)&&$menu_lucia==30){ echo 'class="menu_lucia_active"';} else { echo 'class="menu_lucia_nonactive"';} ?> 
					href="<?php echo base_url();?>formation/offre"><img src="<?php echo base_url();?>assets/img/appels_d_offres.jpg" border="0" height="25" width="35">
					</i>&nbsp;OFFRES DE FORMATIONS</a></li>


					<li <?php if($iMenuActif==10){ echo 'class="active"'; }?> >
					<a <?php if(isset($menu_lucia)&&$menu_lucia==31){ echo 'class="menu_lucia_active"';} else { echo 'class="menu_lucia_nonactive"';} ?> 
					href="<?php echo base_url();?>formation/rapport"><img src="<?php echo base_url();?>assets/img/rapport.icon.jpg" border="0" height="25" width="35">
					</i>&nbsp;RAPPORTS DE FORMATIONS</a></li>
					...
					href="<?php echo base_url();?>formation/info_utile"><img src="<?php echo base_url();?>assets/img/information.icone.jpg" border="0" height="25" width="35">
					</i>&nbsp;INFOS UTILES</a></li>
					...
					href="<?php echo base_url();?>documentation/nouveaute_liste">
					</i>&nbsp;NOUVEAUTES</a></li>
					...
					<li <?php if($iMenuActif==20){ echo 'class="active"'; }?>>
                        ...
                        <ul style="width:250px;">
							...
							<li><a class="color2" href="<?php echo base_url();?>documentation/sad_accueil"></i>Slade</a></li>
					...
					<li <?php if($iMenuActif==16){ echo 'class="active"'; }?>>
						...
						href="#" title=""></i>&nbsp;RESTITUTION</a>
                        <ul style="width:250px;">
							<li><a class="color2" href="<?php echo base_url();?>documentation/flash_info"></i>&nbsp;&nbsp;IMAGES ET VIDEOS</a></li>
							<li><a class="color2" href="<?php echo base_url();?>documentation/planning"></i>&nbsp;&nbsp;PLANNING DE RESTITUTION</a></li>
						</ul>	
                    </li>
					<!-- Fin Docuementations -->
