            ...
            <nav>
                <ul style="<?php echo (isset($menu_lucia))?" padding-top:1px;":"";?>">
				   <?php if(!isset($iModuleActif) || $iModuleActif!=7){ ?>
					...
					<img src="<?php echo base_url();?>assets/img/img_sfao/gif_sfao.gif"  border="0" height="30" width="60">
					...
					<img src="<?php echo base_url();?>assets/img/New.gif"  border="0" height="30" width="60">
					</i>&nbsp;NOUVEAUTES</a></li>
					...
					<li <?php if($iMenuActif==20){ echo 'class="active"'; }?>>
                        ...
                        <ul style="width:250px;">
							...
							<li><a class="color2" href="<?php echo base_url();?>documentation/list_user_sad"></i>AGENTS CONNECTES A SAD</a></li>
					...
					<li <?php if($iMenuActif==16){ echo 'class="active"'; }?>>
						...
						<!--<img src="<?php echo base_url();?>assets/img/New1.gif"  border="0" height="30" width="60">-->
						</i>&nbsp;RESTITUTION</a>	
                    </li>
					<!-- Fin Docuementations -->
