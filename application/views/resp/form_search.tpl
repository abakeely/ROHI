			...
			{include_php file=$zHeader}
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col-12">
								<h3 class="page-title">Affectation localité de service</h3>
								<ul class="breadcrumb">
							...
							<div class="card-body">
								...
								<div class="SSttlPage">
									<div id="searchAcc">
										...
										<h2>Recherche responsable personnel</h2>
										<form action="{$zBasePath}user/search_matricule" method="POST" name="formulaireSearch" id="formulaireSearch" enctype="multipart/form-data" style="display:block;">
