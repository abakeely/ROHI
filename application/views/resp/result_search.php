...
<form action="<?php echo base_url(). "user/valide_respers"; ?>" method="post">
		...
		<div class="row">
			...
			<div class="col-md-6">
					<select class="form-control" placeholder="Service" name="pays" data-toggle="tooltip" data-original-title= "Safidio  ny sampan-draharaha  misy anao " id="pays">
		...
		<div class="row">
			...
			<div class="col-md-6">
					<select class="form-control" placeholder="Service" name="province" data-toggle="tooltip" data-original-title= "Safidio  ny sampan-draharaha  misy anao " id="province">
						<?php foreach($list_province as $d){ 
								$selected = ($d["id"] == $province_edit)  ? ' selected="selected"' : '';
						?>
								<option  value=<?php echo $d["id"];?> <?php echo $selected;?>><?php echo $d["libele"];?></option>
						<?php }?>
				</select>
		...
		<div class="row">
			...
			<div class="col-md-6">
					<select class="form-control" placeholder="Service" name="district" data-toggle="tooltip" data-original-title= "Safidio  ny sampan-draharaha  misy anao " id="district">
