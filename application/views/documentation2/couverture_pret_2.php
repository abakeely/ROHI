...
<center>
 <div class="row">
  <div class="col-md-12">
	...
	<div class="col-md-3"><a href="<?php echo base_url();?>documentation/consultation_surplace" title="CONSULTATION SUR PLACE">
	...
	<div class="col-md-3"><a href="<?php echo base_url();?>documentation/list_user_sad" title="CONNEXION Cybernet">
		  <img class="img_cat" id="cat_2" src="<?php echo base_url();?>assets/img/img_sad/tableau_bord/1cnx.png">
		  </a><br><br>
				<div class="field">
					<a href="<?php echo base_url();?>documentation/list_user_sad" title="CONNEXION Cybernet">
						<img class="img_cat" id="cat_6" src="<?php echo base_url();?>assets/img/img_sad/tableau_bord/bas_cnx_.png">
					</a>
				</div>
	</div>
	<div class="col-md-3"><a href="<?php echo base_url();?>documentation/agent_conecter" title="AGENTS CONNECTES A SAD">
		  <img class="img_cat" id="cat_3" src="<?php echo base_url();?>assets/img/img_sad/tableau_bord/1consad.png">
		  </a><br><br>
				<div class="field">
					<a href="<?php echo base_url();?>documentation/agent_conecter" title="AGENTS CONNECTES A SAD">
						<img class="img_cat" id="cat_7" src="<?php echo base_url();?>assets/img/img_sad/tableau_bord/bas_consad.png">	
					</a>
				</div>
	</div>
	
	<div class="col-md-3"><a href="<?php echo base_url();?>documentation/statistiques" title="STATISTIQUES">
		  <img class="img_cat" id="cat_8" src="<?php echo base_url();?>assets/img/img_sad/tableau_bord/1stat.png">
		  </a><br><br>
				<div class="field">
					<a href="<?php echo base_url();?>documentation/statistiques" title="STATISTIQUES">
...
<div class="col-md-3"><a href="<?php echo base_url();?>documentation/consultation_surplace" title="CONSULTATION SUR PLACE">
	...
	<div class="col-md-3"><a href="<?php echo base_url();?>documentation/documentation/list_user_sad" title="CONNEXION Cybernet">
		  <img class="img_cat" id="cat_2" src="<?php echo base_url();?>assets/img/img_sad/tableau_bord/1cnx.png">
		  </a><br><br>
				<div class="field">
					<a href="<?php echo base_url();?>documentation/documentation/list_user_sad" title="CONNEXION Cybernet">
						<img class="img_cat" id="cat_6" src="<?php echo base_url();?>assets/img/img_sad/tableau_bord/bas_cnx_.png">
					</a>
				</div>
	</div>
