...
<style>
	...
	<div align="right">
		<a href="<?php echo base_url();?>tableau_bord/list_pret_sur_place" class="btn btn-success">PRECEDENT</a>
	</div>
	
<div id="content-wrap" class="row">	

<form class="form-horizontal" role="form" name="lect_ajout" action="<?php echo base_url('tableau_bord/ajout_pret')?>" method="POST">
	<div class="col-lg-6">	
