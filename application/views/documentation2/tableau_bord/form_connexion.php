...
<style>
	...
	<div align="right">
		<a href="<?php echo base_url();?>documentation/conexion_cybernet" class="btn btn-success">PRECEDENT</a>
	 </div>
<div id="content-wrap" class="row">	
<form class="form-horizontal" role="form" name="lect_ajout" action="<?php echo base_url('tableau_bord/ajout_connexion_internet')?>" method="POST">
	<div class="col-lg-6">	
