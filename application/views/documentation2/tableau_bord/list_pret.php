 ...
 <div id="content-wrap" class="row"> 
	<div class="col-md-12">
	  <div class="text-center" >
		<h3><font color="DarkCyan">LISTE DES AGENTS QUI EFFECTUE DES PRÊTS SUR PLACE</font></h43>
	  </div>
	  <div align="right">
		<a href="<?php echo base_url();?>tableau_bord/pret_place" class="btn btn-success">RETOUR</a>
	</div>
	   <div class="row">
	...
	<table class="table table-striped table-bordered table-hover" id="table_liste_pret">
	   <thead>
		<tr >
		   ...
		   <th class="th_livre"> <font size="4"><font face="Times New Roman">date pret</font></font></th>
		   <th class="th_livre"> <font size="4"><font face="Times New Roman">date retour</font></font></th>
		</tr>
	   </thead>	
	   <?php 
		$ordre = 0;
	   ...
	   ?> 
		<tr>
		    ...
		    <td><font size="4"><font face="Times New Roman"><?php 
					$libele = $pret->statut;
					if($pret->statut==1)$libele="Agent";
					if($pret->statut==3)$libele="Autre usager";
					echo $libele;
				?></font></font>
			</td>
			<td ><font size="4"><font face="Times New Roman"><?php echo $pret->nom_prenom?></font></font></td>
			<td ><font size="4"><font face="Times New Roman"><?php echo $pret->cote_livre?></font></font></td>
			<td ><font size="4"><font face="Times New Roman"><?php echo $pret->responsable?></font></font></td>
			<td ><font size="4"><font face="Times New Roman"><?php echo $pret->date_lecture?></font></font></td>
			<td ><font size="4"><font face="Times New Roman"><?php echo $pret->etablissement?></font></font></td>
		</tr>
	   <?php } ?>
   </table>		
  </div>
<script>
 function changeStatut(id,statut){
	 var title = $('#title_'+id).text();
	  ...
	  var msg = "";
	  if(statut==1)
		  msg = "Votre demande a ete pris en compte, vous pouvez recuperer le document aupres de la sad : "+cote+" : "+title +" disponible ?";
	   else
