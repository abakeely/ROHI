 ...
 <div id="content-wrap" class="row"> 
	<div class="col-md-12">
	  <div class="text-center" >
		<h4><font color="DarkCyan">LISTE DES AGENTS CONNECTES SUR CYBERNET</font></h4>
	  </div>
	  <div align="right">
		<a href="<?php echo base_url();?>documentation/conexion_cybernet" class="btn btn-success">RETOUR</a>
	  </div>
	   <div class="row">
	...
	<table class="table table-striped table-bordered table-hover" id="table_liste_pret">
	   <thead>
		<tr >
		   ...
		   <th class="th_livre"><font size="4"><font face="Times New Roman">titre recherche</font></font></th>
	   ...
	   ?> 
		<tr>
			<td style="width:10px"><font size="4"><font face="Times New Roman"><?php echo $ordre;?></td>
			...
			<td><font size="4"><font face="Times New Roman"><?php echo $consul->titre_recherche?></font></font></td>
