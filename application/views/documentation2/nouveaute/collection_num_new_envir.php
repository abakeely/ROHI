...
<center>
	...
	<article>
		<a href="<?php echo base_url();?>assets/pdf_sad/pdf_gst/II.GST.059N.pdf" target="blanck"> 
		<img class="img_cat" id="cat_politique" src="<?php echo base_url();?>assets/pdf_sad/pdf_gst/couv_gst/II.GST.059N.png"  border="0" height="240" width="140">
	  </a>
	
	</article>
	<article>
		<a href="<?php echo base_url();?>assets/pdf_sad/pdf_gst/II.GST.057N.pdf" target="blanck"> 
	  <br><img class="img_cat" id="cat_politique" src="<?php echo base_url();?>assets/pdf_sad/pdf_gst/couv_gst/II.GST.057N.png" border="0" height="240" width="140">
	  </a>
	</article>
<!--	<article>
