...
<tr>
	...
	<td class="zoom"><a href="<?php echo base_url();?>assets/pdf_sad/pdf_drt/II.DRT.062N.pdf"> 
	  <br><img class="img_cat" id="cat_politique" src="<?php echo base_url();?>assets/pdf_sad/pdf_drt/couv_drt/II.DRT.062N.png">
	  </a><br><br>
	 </td>
</tr>
<!--2eme autre--> 
<tr>
	<td class="zoom"><a href="<?php echo base_url();?>assets/pdf_sad/pdf_drt/II.DRT.063N.pdf"> 
	  <br><img class="img_cat" id="cat_politique" src="<?php echo base_url();?>assets/pdf_sad/pdf_drt/couv_drt/II.DRT.063N.png">
	  </a><br><br>
	</td>
	<td class="zoom"><a href="<?php echo base_url();?>assets/pdf_sad/pdf_drt/II.DRT.064N.pdf"> 
	  <br><img class="img_cat" id="cat_politique" src="<?php echo base_url();?>assets/pdf_sad/pdf_drt/couv_drt/II.DRT.064N.png">
	  </a><br><br>
	</td>
</tr>
</table> 
