...
<center>
	 <div class="text-center" >
		<h3><font color="DarkCyan">LES COLLECTIONS NUMERIQUES</font></h3>
	  </div>
 ...
 <div class="row">
  ...
  <div class="col-md-10">
	...
	<div class="row">
		<div class="col-md-1"></div>
			<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/budget" title="Budget">
			...
			<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/eco" title="Economie">
				  <img  id="cat_eco" src="<?php echo base_url();?>assets/img/img_sad/cat_/EcoFace.png"  border="0" height="240" width="170">
				  </a><br><br>
			</div>
			<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/impot" title="Impôt">
