...
<tr>
	<td class="zoom"><a href="<?php echo base_url();?>nouveaute/collection_num"> 
	  <br><img class="img_cat" id="cat_politique" src="<?php echo base_url();?>assets/img/nouv_/1.jpg" title="Collections Numeriques" border="0" height="200" width="220">
	  </a><br><br>
	 </td>
...
<tr>
	<td class="zoom"><a href="<?php echo base_url();?>documentation/pret_livre/10/3533"> 
	  <br><img class="img_cat" id="cat_politique" src="<?php echo base_url();?>assets/img/nouv_/36.jpg" border="0" height="200" width="220">
	  </a><br><br>
	 </td>
</tr>
</table> 
