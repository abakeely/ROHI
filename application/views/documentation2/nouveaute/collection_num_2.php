  ...
  <div class="col-md-10">
	...
	<div class="col-md-1"></div>
		...
		<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/dico" title="Dictionnaire">
			  <img  id="cat_dico" src="<?php echo base_url();?>assets/img/img_sad/cat_/Dico_face.png"  border="0" height="240" width="200">
			  </a><br><br>
		</div>
		<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/droit" title="Droit">
			  <img  id="cat_droit" src="<?php echo base_url();?>assets/img/img_sad/cat_/DroitFace.png"  border="0" height="240" width="200">
			  </a><br><br>
		</div>
		<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/droit" title="Droit">
			  <img  id="cat_droit" src="<?php echo base_url();?>assets/img/img_sad/cat_/DroitFace.png"  border="0" height="240" width="200">
		...
		<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/gestion" title="Gestion">
			  <img  id="cat_gestion" src="<?php echo base_url();?>assets/img/img_sad/cat_/GestionFace.png"  border="0" height="240" width="200">
			  </a><br><br>
		</div>
	...
	<div class="row">
		<div class="col-md-1"></div>
			<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/pas" title="Population et Affaire Sociale">
				  <img  id="cat_pas" src="<?php echo base_url();?>assets/img/img_sad/cat_/PASFace.png"  border="0" height="200" width="200">
				  </a><br><br>							
			</div>		
			<div class="col-md-2"><a href="<?php echo base_url();?>documentation/budget" title="Budget">
				  <img  id="cat_budget" src="<?php echo base_url();?>assets/img/img_sad/cat_/BudgetFace.png"  border="0" height="200" width="200">
				  </a><br><br>
			</div>
			<div class="col-md-2"><a href="<?php echo base_url();?>documentation/budget" title="Budget">
				  <img  id="cat_budget" src="<?php echo base_url();?>assets/img/img_sad/cat_/BudgetFace.png"  border="0" height="200" width="200">
			...
			<div class="col-md-2"><a href="<?php echo base_url();?>nouveaute/douane" title="Douane">
				  <img  id="cat_douane" src="<?php echo base_url();?>assets/img/img_sad/cat_/DouaneFace.png"  border="0" height="240" width="240">
				  </a><br><br>
			</div>
		<div class="col-md-3"></div>
    </div>
