			...
			{include_php file=$zHeader}
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col-12">
								<h3 class="page-title">Liste consultation sur place</h3>
								<ul class="breadcrumb">
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="card-body">
								<div align="right">
									<a href="{$zBasePath}tableau_bord/consultation_surplace/sad/consult-place" class="btn">Retour</a>
								</div>
								<h3 style=" border-bottom: none; important! font-size: 1.1em; font-weight: bold; font-family: Lato;">
									<div align="center">LISTE DES AGENTS QUI CONSULTE DES OUVRAGES SUR PLACE</div>
								</h3>
								<form class="form-horizontal" role="form" name="documentation" id="documentation" action="{$zBasePath}documentaion/catalogue" method="POST"></form>
								<table class="table table-striped table-bordered table-hover" id="table_liste_ouvrage">
									<thead>
										<tr>
										<th>Ordre</th>
										<th>Type usager</th>
