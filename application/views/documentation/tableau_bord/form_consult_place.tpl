			...
			{include_php file=$zHeader}
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col-12">
								<h3 class="page-title">Ajout consultation sur Place</h3>
								<ul class="breadcrumb">
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="card-body">
								<div align="right">
									<a href="{$zBasePath}tableau_bord/consultation_surplace/sad/consult-place" class="btn">PRECEDENT</a>
								</div>
								<div id="content-wrap" >	
									<form class="form-horizontal" role="form" name="lect_ajout" action="{$zBasePath}tableau_bord/ajout_lecture" method="POST">
										<div class="col-lg-6">
										...
										<div class="col-lg-6">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" id="input_heure" class="form-control" placeholder="Heuredentree" name="date Heure" readonly="true" value="{date("H:i")}"> 
													<span class="la la-calendar txt-danger form-control-feedback"></span>
												</div>
											</div>	
											<div class="form-group">
