<style>
	...
	<div align="right">
		<a href="<?php echo base_url();?>documentation/consultation_surplace" class="btn btn-success">PRECEDENT</a>
	</div>
<div id="content-wrap" class="row">	
<form class="form-horizontal" role="form" name="lect_ajout" action="<?php echo base_url('tableau_bord/ajout_lecture')?>" method="POST">
	<div class="col-lg-6">	
	...
	<div class="col-lg-6">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<button type="button" onclick="verifier_livre()">VERIFIER</button>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" id="input_date" class="form-control" placeholder=" Date Lecture" name="" readonly="true" value="<?php echo date("d/m/Y")?>">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" id="input_heure" class="form-control" placeholder="Heuredentree" name="dateheur" readonly="true" value="<?php echo date("H:i")?>"> 
				<span class="la la-calendar txt-danger form-control-feedback"></span>
			</div>
		</div>
