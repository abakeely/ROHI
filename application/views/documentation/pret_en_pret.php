 ...
 <div id="content-wrap" class="row"> 
	...
	<table class="table table-striped table-bordered table-hover" id="table_loi">
	   <thead>
		...
		<?php 
		$ordre = 0;
		 foreach ($list_pret as $pret_en_pret){
			$ordre++;
	   ?> 
		<tr>
			<td style="width:10px"><font size="4"><font face="Times New Roman"><?php echo $ordre;?></font></font></td>
		    <td><font size="3"><font face="Times New Roman"><?php echo $pret_en_pret->date_reservation;?></font></font></td>
		    <?php if($user['role'] == "biblio"){?>
		    <td><font size="4"><font face="Times New Roman"><?php echo $pret_en_pret->candidat?$pret_en_pret->candidat->matricule.'-'.$pret_en_pret->candidat->nom.' '.$pret_en_pret->candidat->prenom:'';?></font></font></td>
		    <?php }?>
			<td><font size="4"><font face="Times New Roman"><?php echo $pret_en_pret->livre->theme_livre['libele'];?></font></font></td>
			<td id="cote_<?php echo $pret_en_pret->id;?>"><font size="4"><font face="Times New Roman"><?php echo $pret_en_pret->livre->cote_livre;?></font></font></td>
			<td id="title_<?php echo $pret_en_pret->id;?>"><font size="4"><font face="Times New Roman"><?php echo $pret_en_pret->livre->titre_livre;?></font></font></td>
			<td ><font size="4"><font face="Times New Roman"><?php echo $pret_en_pret->livre->auteur_livre['libele'];?></font></font></td>
			<td><font size="4"><font face="Times New Roman"><?php echo $pret_en_pret->livre->edition_livre;?></font></font></td>
			 <?php if($user['role'] != "biblio"){?>
			<td><font size="4"><font face="Times New Roman"><?php echo $pret_en_pret->livre->lieu_livre['libele'];?></font></font></td>
			 <?php }?>
			<td><font size="3"><font face="Times New Roman"><?php echo $pret_en_pret->livre->langue_livre['libele'];?></font></font></td>
			<td><font size="3"><font face="Times New Roman"><?php echo $pret_en_pret->date_validation?></font></font></td>
			<td><font size="3"><font face="Times New Roman"><?php echo $pret_en_pret->date_retour?></font></font></td>
			<?php if($user['role'] == "biblio"){?>
			<td><font size="3"><font face="Times New Roman"><?php echo $pret_en_pret->date_retour2?></font></font></td>
			<!--<td><//?php echo $pret_en_pret->date_email?></td>-->
			<?php }?>
			<td>			
				<?php if($pret_en_pret->statut == 0){?>
					<?php if($user['role'] == "biblio"){?>
						<img src="<?php echo base_url();?>assets/img/disponible.png" alt="Disponible" class="to_click" border="0" height="30" onclick="changeStatut(<?php echo $pret_en_pret->id;?>,1)">
						<img src="<?php echo base_url();?>assets/img/en_pret_en_pret.png" alt=" En pr&ecirc;t"  class="to_click" border="0" height="38" width="38" onclick="changeStatut(<?php echo $pret_en_pret->id;?>,2)">
						<img src="<?php echo base_url();?>assets/img/email.png" title="Livre envoie par email" class="to_click"  border="0" height="30" onclick="changeStatut(<?php echo $pret_en_pret->id;?>,4)">
					...
					<?php } else {?>
						...
						<img src="<?php echo base_url();?>assets/img/en_pret_en_pret.png" alt="En pr&ecirc;t"  border="0" height="40" width="40">
						<img src="<?php echo base_url();?>assets/img/retour2.png" alt="Rendu"  border="0" height="28" width="28">
						
					<?php } ?>
				<?php } ?>
				<?php if($pret_en_pret->statut == 1){?>
				<?php if($user['role'] == "biblio"){?>
					<img src="<?php echo base_url();?>assets/img/disponible.png" alt="Disponible"  border="0" height="28" width="28">
					<img src="<?php echo base_url();?>assets/img/retour2.png" class="to_click" alt="Rendu"  border="0"  height="28" onclick="changeStatut(<?php echo $pret_en_pret->id;?>,3)">
					<?php } else {?>
				...
				<?php } ?>
				<?php if($pret_en_pret->statut == 2){?>
					<img src="<?php echo base_url();?>assets/img/en_pret_en_pret.png" title="En pr&ecirc;t"  class="to_click" border="0" height="30" onclick="changeStatut(<?php echo $pret_en_pret->id;?>,1)">
				<?php } ?>
				<?php if($pret_en_pret->statut == 3){?>
					<img src="<?php echo base_url();?>assets/img/retour2.png" title="Rendu"  border="0" height="28">
				<?php } ?>
				<?php if($pret_en_pret->statut == 4){?>
					<img src="<?php echo base_url();?>assets/img/email.png" title="Livre envoie par email" border="0" height="28">
				<?php } ?>
			</td>
		  <?php if($user['role'] == "biblio"){?>
			<td><a class="color2" href="<?php echo base_url();?>cv/fpdf_cv/<?php echo $pret_en_pret->candidat->id?>"><img src="<?php echo base_url();?>assets/img/cv.png" border="0" height="53" width="60"></a></td><?php }?>
		  </tr>
	   <?php } ?>
   </table>			
  </div>
